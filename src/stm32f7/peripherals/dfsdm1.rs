...
pub mod DFSDM2_DATAR {
    pub use super::DFSDM1_DATAR::JDATA;
    pub use super::DFSDM1_DATAR::JDATACH;
    pub use super::DFSDM1_DATAR::RDATA;
    pub use super::DFSDM1_DATAR::RDATACH;
    pub use super::DFSDM1_DATAR::RPEND;
}
...
pub struct RegisterBlock {
    ...
    /// DFSDM1_JDATAR: DFSDM data register for injected group
    /// DFSDM1_RDATAR: DFSDM data register for the regular channel
    pub DFSDM1_DATAR: RWRegister<u32>,
