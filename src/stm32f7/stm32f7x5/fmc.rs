...
pub mod BCR1 {
    ...
    pub mod CCLKEN {
        ...
        pub mod RW {
            ...
            /// 0b1: FMC_CLK clock output to external memory devices enabled
            pub const Enabled: u32 = 0b1;

            /// 0b0: FMC_CLK clock output to external memory devices disabled
...
pub mod SDCR1 {
    ...
    pub mod SDCLK {
        ...
        pub mod RW {
            ...
            pub const Mul2: u32 = 0b10;

            /// 0b11: SDCLK period = 3 x HCLK period
            pub const Mul3: u32 = 0b11;
        }
    }
...
pub mod SDCMR {
    ...
    pub mod CTB2 {
        ...
        pub mod RW {
            ...
            /// 0b0: Command not issued to SDRAM Bank 2
            pub const NotIssued: u32 = 0b0;

            /// 0b1: Command issued to SDRAM Bank 2
