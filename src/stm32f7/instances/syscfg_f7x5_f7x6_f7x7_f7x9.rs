...
pub use stm32f7::peripherals::syscfg_v2::Instance;
pub use stm32f7::peripherals::syscfg_v2::{RegisterBlock, ResetValues};
pub use stm32f7::peripherals::syscfg_v2::{CMPCR, EXTICR1, EXTICR2, EXTICR3, EXTICR4, MEMRM, PMC};
