...
pub use crate::stm32f7::peripherals::pwr_v2::Instance;
pub use crate::stm32f7::peripherals::pwr_v2::{RegisterBlock, ResetValues};
pub use crate::stm32f7::peripherals::pwr_v2::{CR1, CR2, CSR1, CSR2};
