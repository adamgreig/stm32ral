...
pub use stm32f7::peripherals::pwr_v1::Instance;
pub use stm32f7::peripherals::pwr_v1::{RegisterBlock, ResetValues};
pub use stm32f7::peripherals::pwr_v1::{CR1, CR2, CSR1, CSR2};
