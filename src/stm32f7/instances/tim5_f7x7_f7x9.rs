...
pub use crate::stm32f7::peripherals::tim4_v2::Instance;
pub use crate::stm32f7::peripherals::tim4_v2::{RegisterBlock, ResetValues};
pub use crate::stm32f7::peripherals::tim4_v2::{
