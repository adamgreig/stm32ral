...
pub use stm32f7::peripherals::ethernet_mac::Instance;
pub use stm32f7::peripherals::ethernet_mac::{RegisterBlock, ResetValues};
pub use stm32f7::peripherals::ethernet_mac::{
