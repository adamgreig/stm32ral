...
pub use crate::stm32f7::peripherals::ethernet_mac::Instance;
pub use crate::stm32f7::peripherals::ethernet_mac::{RegisterBlock, ResetValues};
pub use crate::stm32f7::peripherals::ethernet_mac::{
    MACA0HR, MACA0LR, MACA1HR, MACA1LR, MACA2HR, MACA2LR, MACA3HR, MACA3LR, MACCR, MACDBGR, MACFCR,
    MACFFR, MACHTHR, MACHTLR, MACIMR, MACMIIAR, MACMIIDR, MACPMTCSR, MACRWUFFER, MACSR, MACVLANTR,
};
