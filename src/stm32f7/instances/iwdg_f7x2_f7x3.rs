...
pub use stm32f7::peripherals::iwdg_v1::Instance;
pub use stm32f7::peripherals::iwdg_v1::{RegisterBlock, ResetValues};
pub use stm32f7::peripherals::iwdg_v1::{KR, PR, RLR, SR, WINR};
