...
pub use stm32f7::peripherals::pwr_v2::Instance;
pub use stm32f7::peripherals::pwr_v2::{RegisterBlock, ResetValues};
pub use stm32f7::peripherals::pwr_v2::{CR1, CR2, CSR1, CSR2};
