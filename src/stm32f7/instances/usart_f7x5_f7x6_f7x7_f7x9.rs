...
pub use stm32f7::peripherals::usart_v2::Instance;
pub use stm32f7::peripherals::usart_v2::{RegisterBlock, ResetValues};
pub use stm32f7::peripherals::usart_v2::{BRR, CR1, CR2, CR3, GTPR, ICR, ISR, RDR, RQR, RTOR, TDR};
