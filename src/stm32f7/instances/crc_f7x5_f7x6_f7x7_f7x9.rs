...
pub use stm32f7::peripherals::crc_v2::Instance;
pub use stm32f7::peripherals::crc_v2::{RegisterBlock, ResetValues};
pub use stm32f7::peripherals::crc_v2::{CR, DR, IDR, INIT, POL};
