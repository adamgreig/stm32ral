...
pub use stm32f7::peripherals::dbgmcu_v2::Instance;
pub use stm32f7::peripherals::dbgmcu_v2::{RegisterBlock, ResetValues};
pub use stm32f7::peripherals::dbgmcu_v2::{APB1_FZ, APB2_FZ, CR, IDCODE};
