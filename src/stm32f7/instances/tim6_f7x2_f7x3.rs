...
pub use stm32f7::peripherals::tim6_v1::Instance;
pub use stm32f7::peripherals::tim6_v1::{RegisterBlock, ResetValues};
pub use stm32f7::peripherals::tim6_v1::{ARR, CNT, CR1, CR2, DIER, EGR, PSC, SR};
