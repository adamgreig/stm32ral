...
pub use stm32f7::peripherals::can::Instance;
pub use stm32f7::peripherals::can::{RegisterBlock, ResetValues};
pub use stm32f7::peripherals::can::{
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const CAN3: *const RegisterBlock = 0x40003400 as *const _;
