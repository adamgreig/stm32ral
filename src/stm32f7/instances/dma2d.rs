...
pub use crate::stm32f7::peripherals::dma2d::Instance;
pub use crate::stm32f7::peripherals::dma2d::{RegisterBlock, ResetValues};
pub use crate::stm32f7::peripherals::dma2d::{
