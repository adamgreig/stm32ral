...
pub use stm32f7::peripherals::otg_hs_host_v1::Instance;
pub use stm32f7::peripherals::otg_hs_host_v1::{RegisterBlock, ResetValues};
pub use stm32f7::peripherals::otg_hs_host_v1::{
