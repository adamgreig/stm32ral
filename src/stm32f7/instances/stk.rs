...
pub use crate::stm32f7::peripherals::stk::Instance;
pub use crate::stm32f7::peripherals::stk::{RegisterBlock, ResetValues};
pub use crate::stm32f7::peripherals::stk::{CALIB, CSR, CVR, RVR};
