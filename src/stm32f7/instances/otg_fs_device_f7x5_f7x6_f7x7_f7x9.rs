...
pub use stm32f7::peripherals::otg_fs_device_v2::Instance;
pub use stm32f7::peripherals::otg_fs_device_v2::{RegisterBlock, ResetValues};
pub use stm32f7::peripherals::otg_fs_device_v2::{
