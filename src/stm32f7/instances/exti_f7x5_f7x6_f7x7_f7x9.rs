...
pub use stm32f7::peripherals::exti_v2::Instance;
pub use stm32f7::peripherals::exti_v2::{RegisterBlock, ResetValues};
pub use stm32f7::peripherals::exti_v2::{EMR, FTSR, IMR, PR, RTSR, SWIER};
