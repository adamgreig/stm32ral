...
pub use stm32f7::peripherals::otg_hs_global_v2::Instance;
pub use stm32f7::peripherals::otg_hs_global_v2::{RegisterBlock, ResetValues};
pub use stm32f7::peripherals::otg_hs_global_v2::{
