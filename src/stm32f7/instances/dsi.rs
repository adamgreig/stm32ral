...
pub use crate::stm32f7::peripherals::dsi::{
    ...
    VHSACR, VLCCR, VLCR, VMCCR, VMCR, VNPCCR, VNPCR, VPCCR, VPCR, VR, VSCR, VVACCR, VVACR, VVBPCCR,
    VVBPCR, VVFPCCR, VVFPCR, VVSACCR, VVSACR, WCFGR, WCR, WIER, WIFCR, WISR, WPCR1, WPCR2, WPCR3,
    WPCR4, WPCR5, WRPCR,
};
