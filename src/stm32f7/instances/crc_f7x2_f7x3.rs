...
pub use stm32f7::peripherals::crc_v1::Instance;
pub use stm32f7::peripherals::crc_v1::{RegisterBlock, ResetValues};
pub use stm32f7::peripherals::crc_v1::{CR, DR, IDR, INIT, POL};
