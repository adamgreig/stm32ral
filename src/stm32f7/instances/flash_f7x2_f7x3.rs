...
pub use stm32f7::peripherals::flash_v1::Instance;
pub use stm32f7::peripherals::flash_v1::{RegisterBlock, ResetValues};
pub use stm32f7::peripherals::flash_v1::{ACR, CR, KEYR, OPTCR, OPTCR1, OPTCR2, OPTKEYR, SR};
