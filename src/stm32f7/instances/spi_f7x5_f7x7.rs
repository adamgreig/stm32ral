...
//!
//! Used by: stm32f7x5, stm32f7x7

#[cfg(not(feature = "nosync"))]
pub use stm32f7::peripherals::spi::Instance;
pub use stm32f7::peripherals::spi::{RegisterBlock, ResetValues};
pub use stm32f7::peripherals::spi::{CR1, CR2, CRCPR, DR, I2SCFGR, I2SPR, RXCRCR, SR, TXCRCR};
