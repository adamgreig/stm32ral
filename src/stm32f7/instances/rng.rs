...
pub use crate::stm32f7::peripherals::rng::Instance;
pub use crate::stm32f7::peripherals::rng::{RegisterBlock, ResetValues};
pub use crate::stm32f7::peripherals::rng::{CR, DR, SR};
