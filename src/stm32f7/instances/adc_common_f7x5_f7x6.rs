...
pub use stm32f7::peripherals::adc_common_v2::Instance;
pub use stm32f7::peripherals::adc_common_v2::{RegisterBlock, ResetValues};
pub use stm32f7::peripherals::adc_common_v2::{CCR, CDR, CSR};
