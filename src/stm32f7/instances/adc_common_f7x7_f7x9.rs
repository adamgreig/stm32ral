...
pub use stm32f7::peripherals::adc_common_v3::Instance;
pub use stm32f7::peripherals::adc_common_v3::{RegisterBlock, ResetValues};
pub use stm32f7::peripherals::adc_common_v3::{CCR, CDR, CSR};
