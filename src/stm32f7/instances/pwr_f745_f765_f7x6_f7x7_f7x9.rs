...
pub use crate::stm32f7::peripherals::pwr_v1::Instance;
pub use crate::stm32f7::peripherals::pwr_v1::{RegisterBlock, ResetValues};
pub use crate::stm32f7::peripherals::pwr_v1::{CR1, CR2, CSR1, CSR2};
