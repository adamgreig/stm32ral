...
pub use stm32f7::peripherals::flash_v2::Instance;
pub use stm32f7::peripherals::flash_v2::{RegisterBlock, ResetValues};
pub use stm32f7::peripherals::flash_v2::{ACR, CR, KEYR, OPTCR, OPTCR1, OPTKEYR, SR};
