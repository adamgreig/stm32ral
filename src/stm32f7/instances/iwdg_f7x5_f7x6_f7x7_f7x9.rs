...
pub use crate::stm32f7::peripherals::iwdg_v2::Instance;
pub use crate::stm32f7::peripherals::iwdg_v2::{RegisterBlock, ResetValues};
pub use crate::stm32f7::peripherals::iwdg_v2::{KR, PR, RLR, SR, WINR};
