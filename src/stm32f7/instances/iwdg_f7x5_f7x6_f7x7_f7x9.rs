...
pub use stm32f7::peripherals::iwdg_v2::Instance;
pub use stm32f7::peripherals::iwdg_v2::{RegisterBlock, ResetValues};
pub use stm32f7::peripherals::iwdg_v2::{KR, PR, RLR, SR, WINR};
