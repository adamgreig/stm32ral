...
pub use stm32f7::peripherals::otg_hs_pwrclk::Instance;
pub use stm32f7::peripherals::otg_hs_pwrclk::OTG_HS_PCGCR;
pub use stm32f7::peripherals::otg_hs_pwrclk::{RegisterBlock, ResetValues};
