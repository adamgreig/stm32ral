...
pub use crate::stm32l4::peripherals::lpuart1_v2::Instance;
pub use crate::stm32l4::peripherals::lpuart1_v2::{RegisterBlock, ResetValues};
pub use crate::stm32l4::peripherals::lpuart1_v2::{
