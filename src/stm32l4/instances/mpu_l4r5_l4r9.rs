...
pub use crate::stm32l4::peripherals::mpu_v2::Instance;
pub use crate::stm32l4::peripherals::mpu_v2::{RegisterBlock, ResetValues};
pub use crate::stm32l4::peripherals::mpu_v2::{CTRL, RASR, RBAR, RNR, TYPER};
