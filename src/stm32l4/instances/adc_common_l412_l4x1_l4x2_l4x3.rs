...
pub use crate::stm32l4::peripherals::adc_common_v1::Instance;
pub use crate::stm32l4::peripherals::adc_common_v1::{RegisterBlock, ResetValues};
pub use crate::stm32l4::peripherals::adc_common_v1::{CCR, CDR, CSR};
