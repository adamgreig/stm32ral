...
pub use crate::stm32l4::peripherals::tim15_v1::Instance;
pub use crate::stm32l4::peripherals::tim15_v1::{RegisterBlock, ResetValues};
pub use crate::stm32l4::peripherals::tim15_v1::{
