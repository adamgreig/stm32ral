...
pub use crate::stm32l4::peripherals::lpuart1_v1::Instance;
pub use crate::stm32l4::peripherals::lpuart1_v1::{RegisterBlock, ResetValues};
pub use crate::stm32l4::peripherals::lpuart1_v1::{BRR, CR1, CR2, CR3, ICR, ISR, RDR, RQR, TDR};
