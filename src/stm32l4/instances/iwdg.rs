...
pub use crate::stm32l4::peripherals::iwdg::Instance;
pub use crate::stm32l4::peripherals::iwdg::{RegisterBlock, ResetValues};
pub use crate::stm32l4::peripherals::iwdg::{KR, PR, RLR, SR, WINR};
