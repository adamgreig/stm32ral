...
pub use stm32l4::peripherals::dbgmcu_v2::Instance;
pub use stm32l4::peripherals::dbgmcu_v2::{RegisterBlock, ResetValues};
pub use stm32l4::peripherals::dbgmcu_v2::{APB1_FZR1, APB1_FZR2, APB2_FZR, CR, IDCODE};
