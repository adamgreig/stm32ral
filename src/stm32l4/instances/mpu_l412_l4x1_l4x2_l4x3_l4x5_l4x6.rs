...
pub use crate::stm32l4::peripherals::mpu_v1::Instance;
pub use crate::stm32l4::peripherals::mpu_v1::{RegisterBlock, ResetValues};
pub use crate::stm32l4::peripherals::mpu_v1::{CTRL, RASR, RBAR, RNR, TYPER};
