...
pub use crate::stm32l4::peripherals::tim15_v2::Instance;
pub use crate::stm32l4::peripherals::tim15_v2::{RegisterBlock, ResetValues};
pub use crate::stm32l4::peripherals::tim15_v2::{
    ARR, BDTR, CCER, CCMR1, CCR1, CCR2, CNT, CR1, CR2, DCR, DIER, DMAR, EGR, PSC, RCR, SR,
};
