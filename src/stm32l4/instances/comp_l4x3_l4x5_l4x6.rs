...
pub use stm32l4::peripherals::comp_v2::Instance;
pub use stm32l4::peripherals::comp_v2::{RegisterBlock, ResetValues};
pub use stm32l4::peripherals::comp_v2::{COMP1_CSR, COMP2_CSR};
