...
pub use crate::stm32l4::peripherals::adc_common_v2::Instance;
pub use crate::stm32l4::peripherals::adc_common_v2::{RegisterBlock, ResetValues};
pub use crate::stm32l4::peripherals::adc_common_v2::{CCR, CDR, CSR};
