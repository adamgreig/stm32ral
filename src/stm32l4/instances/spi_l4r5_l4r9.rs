...
pub use crate::stm32l4::peripherals::spi_v2::Instance;
pub use crate::stm32l4::peripherals::spi_v2::{RegisterBlock, ResetValues};
pub use crate::stm32l4::peripherals::spi_v2::{CR1, CR2, CRCPR, DR, RXCRCR, SR, TXCRCR};
