...
pub use crate::stm32l4::peripherals::dmamux1::Instance;
pub use crate::stm32l4::peripherals::dmamux1::{RegisterBlock, ResetValues};
pub use crate::stm32l4::peripherals::dmamux1::{
    C0CR, C10CR, C11CR, C12CR, C13CR, C1CR, C2CR, C3CR, C4CR, C5CR, C6CR, C7CR, C8CR, C9CR, CFR,
    CSR, RG0CR, RG1CR, RG2CR, RG3CR, RGCFR, RGSR,
};
