...
pub use stm32l4::peripherals::spi::Instance;
pub use stm32l4::peripherals::spi::{RegisterBlock, ResetValues};
pub use stm32l4::peripherals::spi::{CR1, CR2, CRCPR, DR, RXCRCR, SR, TXCRCR};
