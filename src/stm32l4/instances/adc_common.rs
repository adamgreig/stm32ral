...
pub use crate::stm32l4::peripherals::adc_common::Instance;
pub use crate::stm32l4::peripherals::adc_common::{RegisterBlock, ResetValues};
pub use crate::stm32l4::peripherals::adc_common::{CCR, CDR, CSR};
