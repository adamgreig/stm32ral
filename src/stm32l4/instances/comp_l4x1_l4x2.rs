...
pub use stm32l4::peripherals::comp_v1::Instance;
pub use stm32l4::peripherals::comp_v1::{RegisterBlock, ResetValues};
pub use stm32l4::peripherals::comp_v1::{COMP1_CSR, COMP2_CSR};
