...
/// Access functions for the ADC123_Common peripheral instance
pub mod ADC123_Common {
    ...
    /// Reset values for each field in ADC123_Common
    ...
    #[no_mangle]
    static mut ADC123_Common_TAKEN: bool = false;

    /// Safe access to ADC123_Common
    ///
    ...
    pub fn take() -> Option<Instance> {
        external_cortex_m::interrupt::free(|_| unsafe {
            if ADC123_Common_TAKEN {
                None
            } else {
                ADC123_Common_TAKEN = true;
                Some(INSTANCE)
            }
        })
    }

    /// Release exclusive access to ADC123_Common
    ///
    ...
    pub fn release(inst: Instance) {
        external_cortex_m::interrupt::free(|_| unsafe {
            if ADC123_Common_TAKEN && inst.addr == INSTANCE.addr {
                ADC123_Common_TAKEN = false;
            } else {
...
pub const ADC123_Common: *const RegisterBlock = 0x50040300 as *const _;
