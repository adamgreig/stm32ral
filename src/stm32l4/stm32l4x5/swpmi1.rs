...
pub mod SWPMI1 {
    ...
    /// Reset values for each field in SWPMI1
    ...
    #[no_mangle]
    static mut SWPMI1_TAKEN: bool = false;

    /// Safe access to SWPMI1
    ///
    ...
    /// Release exclusive access to SWPMI1
    ///
    ...
    pub fn release(inst: Instance) {
        external_cortex_m::interrupt::free(|_| unsafe {
            if SWPMI1_TAKEN && inst.addr == INSTANCE.addr {
                SWPMI1_TAKEN = false;
            } else {
...
pub const SWPMI1: *const RegisterBlock = 0x40008800 as *const _;
