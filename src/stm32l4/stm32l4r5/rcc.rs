...
pub mod AHB3ENR {
    ...
    /// OSPI1 memory interface clock enable
    pub mod OSPI1EN {
        /// Offset (8 bits)
        pub const offset: u32 = 8;
        /// Mask (1 bit: 1 << 8)
...
pub mod AHB3SMENR {
    ...
    /// OSPI1 memory interface clock enable during Sleep and Stop modes
    pub mod OSPI1SMEN {
        /// Offset (8 bits)
        pub const offset: u32 = 8;
        /// Mask (1 bit: 1 << 8)
...
pub mod DLYCFGR {
    ...
    /// Delay sampling configuration on OCTOSPI1
    ...
    /// Delay sampling configuration on OCTOSPI2
