...
pub mod WCCR {
    pub use super::CCR::ABDTR;
    pub use super::CCR::ABMODE;
    pub use super::CCR::ABSIZE;
    pub use super::CCR::ADDTR;
    pub use super::CCR::ADMODE;
    pub use super::CCR::ADSIZE;
    pub use super::CCR::DDTR;
    pub use super::CCR::DMODE;
    pub use super::CCR::DQSE;
    pub use super::CCR::IDTR;
    pub use super::CCR::IMODE;
    pub use super::CCR::ISIZE;
    pub use super::CCR::SIOO;
}
