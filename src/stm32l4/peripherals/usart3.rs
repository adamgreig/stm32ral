...
pub mod CR3 {
    ...
    pub mod UCESM {
        ...
        pub mod RW {
            ...
            /// 0b0: USART clock is disabled in STOP mode
            pub const Disabled: u32 = 0b0;

            /// 0b1: USART clock is enabled in STOP mode
            pub const Enabled: u32 = 0b1;
        }
    }
    ...
    pub mod TCBGTIE {
        ...
        pub mod RW {
            ...
            /// 0b1: An USART interrupt is generated whenever TCBGT=1 in the ISR register
            pub const Enabled: u32 = 0b1;
        }
    }
}
