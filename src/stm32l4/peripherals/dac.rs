...
pub mod CR {
    ...
    pub mod TSEL1 {
        ...
        pub mod RW {
            ...
            /// 0b000: TIM6_TRGO event trigger for DAC conversion, if TEN is enabled
            pub const TIM6_TRGO: u32 = 0b000;

            /// 0b001: TIM8_TRGO
            pub const TIM8_TRGO: u32 = 0b001;

            /// 0b010: TIM7_TRGO (Note: Reserved on STM32L45xxx and STM32L46xxx devices)
            ...
            /// 0b111: Software triger
            pub const SWTRIG: u32 = 0b111;
        }
    }
