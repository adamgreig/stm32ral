...
pub use crate::stm32l1::peripherals::wwdg::Instance;
pub use crate::stm32l1::peripherals::wwdg::{RegisterBlock, ResetValues};
pub use crate::stm32l1::peripherals::wwdg::{CFR, CR, SR};
