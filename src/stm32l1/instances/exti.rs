...
pub use stm32l1::peripherals::exti::Instance;
pub use stm32l1::peripherals::exti::{RegisterBlock, ResetValues};
pub use stm32l1::peripherals::exti::{EMR, FTSR, IMR, PR, RTSR, SWIER};
