...
pub use crate::stm32l1::peripherals::stk::Instance;
pub use crate::stm32l1::peripherals::stk::{RegisterBlock, ResetValues};
pub use crate::stm32l1::peripherals::stk::{CALIB, CTRL, LOAD_, VAL};
