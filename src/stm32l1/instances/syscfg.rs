...
pub use stm32l1::peripherals::syscfg::Instance;
pub use stm32l1::peripherals::syscfg::{RegisterBlock, ResetValues};
pub use stm32l1::peripherals::syscfg::{EXTICR1, EXTICR2, EXTICR3, EXTICR4, MEMRMP, PMC};
