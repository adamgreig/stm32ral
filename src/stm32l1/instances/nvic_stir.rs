...
pub use stm32l1::peripherals::nvic_stir::Instance;
pub use stm32l1::peripherals::nvic_stir::STIR;
pub use stm32l1::peripherals::nvic_stir::{RegisterBlock, ResetValues};
