...
pub use crate::stm32l1::peripherals::nvic_stir::Instance;
pub use crate::stm32l1::peripherals::nvic_stir::STIR;
pub use crate::stm32l1::peripherals::nvic_stir::{RegisterBlock, ResetValues};
