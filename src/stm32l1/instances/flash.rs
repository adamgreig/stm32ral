...
pub use crate::stm32l1::peripherals::flash::Instance;
pub use crate::stm32l1::peripherals::flash::{RegisterBlock, ResetValues};
pub use crate::stm32l1::peripherals::flash::{
