...
pub use stm32l1::peripherals::spi::Instance;
pub use stm32l1::peripherals::spi::{RegisterBlock, ResetValues};
pub use stm32l1::peripherals::spi::{CR1, CR2, CRCPR, DR, I2SCFGR, I2SPR, RXCRCR, SR, TXCRCR};
