...
pub use crate::stm32l1::peripherals::dbgmcu::Instance;
pub use crate::stm32l1::peripherals::dbgmcu::{RegisterBlock, ResetValues};
pub use crate::stm32l1::peripherals::dbgmcu::{APB1_FZ, APB2_FZ, CR, IDCODE};
