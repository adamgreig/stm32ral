...
pub mod LPOTR {
    ...
    pub mod AO3_OPT_OFFSET_TRIM_LP {
        /// Offset (20 bits)
        pub const offset: u32 = 20;
        /// Mask (10 bits: 0x3ff << 20)
        pub const mask: u32 = 0x3ff << offset;
    ...
    pub mod AO2_OPT_OFFSET_TRIM_LP {
        /// Offset (10 bits)
        pub const offset: u32 = 10;
        /// Mask (10 bits: 0x3ff << 10)
        pub const mask: u32 = 0x3ff << offset;
    ...
    pub mod AO1_OPT_OFFSET_TRIM_LP {
        /// Offset (0 bits)
        pub const offset: u32 = 0;
        /// Mask (10 bits: 0x3ff << 0)
        pub const mask: u32 = 0x3ff << offset;
...
pub struct RegisterBlock {
    ...
    /// offset trimming register for normal mode
    pub OTR: RWRegister<u32>,

    /// OPAMP offset trimming register for low power mode
    pub LPOTR: RWRegister<u32>,
}
