...
pub struct RegisterBlock {
    /// GPIO port mode register
    pub GPIOZ_MODER: RWRegister<u32>,

    /// GPIO port output type register
    pub GPIOZ_OTYPER: RWRegister<u32>,

    /// GPIO port output speed register
    pub GPIOZ_OSPEEDR: RWRegister<u32>,

    /// GPIO port pull-up/pull-down register
    pub GPIOZ_PUPDR: RWRegister<u32>,

    /// GPIO port input data register
    pub GPIOZ_IDR: RORegister<u32>,

    /// GPIO port output data register
    pub GPIOZ_ODR: RWRegister<u32>,

    /// GPIO port bit set/reset register
    pub GPIOZ_BSRR: WORegister<u32>,

    /// This register is used to lock the configuration of the port bits when a correct write sequence is applied to bit 16 (LCKK). The value of bits \[15:0\] is used to lock the configuration of the GPIO. During the write sequence, the value of LCKR\[15:0\] must not change. When the LOCK sequence has been applied on a port bit, the value of this port bit can no longer be modified until the next MCU reset or peripheral reset. A specific write sequence is used to write to the GPIOx_LCKR register. Only word access (32-bit long) is allowed during this locking sequence. Each lock bit freezes a specific configuration register (control and alternate function registers).
    pub GPIOZ_LCKR: RWRegister<u32>,

    /// GPIO alternate function low register
    pub GPIOZ_AFRL: RWRegister<u32>,

    /// GPIO alternate function high register
    pub GPIOZ_AFRH: RWRegister<u32>,
    ...
    /// For GPIOA, B, C, D, E, F, G, H, I, and GPIOJ: For GPIOK and GPIOZ:
    pub GPIOZ_HWCFGR9: RORegister<u32>,

    /// For GPIOA, B, C, D, E, F, G, H, I, and GPIOJ: For GPIOK and GPIOZ:
    pub GPIOZ_HWCFGR8: RORegister<u32>,

    /// GPIO hardware configuration register 7
    pub GPIOZ_HWCFGR7: RORegister<u32>,

    /// GPIO hardware configuration register 6
    pub GPIOZ_HWCFGR6: RORegister<u32>,

    /// GPIO hardware configuration register 5
    pub GPIOZ_HWCFGR5: RORegister<u32>,

    /// GPIO hardware configuration register 4
    pub GPIOZ_HWCFGR4: RORegister<u32>,

    /// GPIO hardware configuration register 3
    pub GPIOZ_HWCFGR3: RORegister<u32>,

    /// GPIO hardware configuration register 2
    pub GPIOZ_HWCFGR2: RORegister<u32>,

    /// GPIO hardware configuration register 1
    pub GPIOZ_HWCFGR1: RORegister<u32>,

    /// GPIO hardware configuration register 0
    pub GPIOZ_HWCFGR0: RORegister<u32>,

    /// GPIO version register
    pub GPIOZ_VERR: RORegister<u32>,

    /// GPIO identification register
    pub GPIOZ_IPIDR: RORegister<u32>,

    /// GPIO size identification register
    pub GPIOZ_SIDR: RORegister<u32>,
}
pub struct ResetValues {
    pub GPIOZ_MODER: u32,
    pub GPIOZ_OTYPER: u32,
    pub GPIOZ_OSPEEDR: u32,
    pub GPIOZ_PUPDR: u32,
    pub GPIOZ_IDR: u32,
    pub GPIOZ_ODR: u32,
    pub GPIOZ_BSRR: u32,
    ...
    pub GPIOZ_AFRH: u32,
    pub GPIOZ_BRR: u32,
    pub GPIOZ_SECCFGR: u32,
    pub GPIOZ_HWCFGR10: u32,
    pub GPIOZ_HWCFGR9: u32,
    pub GPIOZ_HWCFGR8: u32,
    pub GPIOZ_HWCFGR7: u32,
    pub GPIOZ_HWCFGR6: u32,
    pub GPIOZ_HWCFGR5: u32,
    pub GPIOZ_HWCFGR4: u32,
    pub GPIOZ_HWCFGR3: u32,
    pub GPIOZ_HWCFGR2: u32,
    pub GPIOZ_HWCFGR1: u32,
    pub GPIOZ_HWCFGR0: u32,
    pub GPIOZ_VERR: u32,
    pub GPIOZ_IPIDR: u32,
    pub GPIOZ_SIDR: u32,
}
