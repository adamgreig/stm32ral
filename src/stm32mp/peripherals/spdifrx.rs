...
pub struct RegisterBlock {
    /// Control register
    pub SPDIFRX_CR: RWRegister<u32>,

    /// Interrupt mask register
    pub SPDIFRX_IMR: RWRegister<u32>,

    /// Status register
    pub SPDIFRX_SR: RORegister<u32>,

    /// Interrupt flag clear register
    pub SPDIFRX_IFCR: RWRegister<u32>,

    /// This register can take 3 different formats according to DRFMT. Here is the format when DRFMT = 00:
    pub SPDIFRX_FMT0_DR: RORegister<u32>,

    /// Channel status register
    pub SPDIFRX_CSR: RORegister<u32>,

    /// Debug information register
    pub SPDIFRX_DIR: RORegister<u32>,

    _reserved1: [u32; 246],

    /// SPDIFRX version register
    pub SPDIFRX_VERR: RORegister<u32>,

    /// SPDIFRX identification register
    pub SPDIFRX_IPIDR: RORegister<u32>,

    /// SPDIFRX size identification register
    pub SPDIFRX_SIDR: RORegister<u32>,
}
