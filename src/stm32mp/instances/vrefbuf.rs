...
pub use crate::stm32mp::peripherals::vrefbuf::Instance;
pub use crate::stm32mp::peripherals::vrefbuf::{RegisterBlock, ResetValues};
pub use crate::stm32mp::peripherals::vrefbuf::{VREFBUF_CCR, VREFBUF_CSR};
...
pub const VREFBUF: *const RegisterBlock = 0x50025000 as *const _;
