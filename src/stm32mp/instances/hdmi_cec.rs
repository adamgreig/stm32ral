...
pub use crate::stm32mp::peripherals::hdmi_cec::Instance;
pub use crate::stm32mp::peripherals::hdmi_cec::{RegisterBlock, ResetValues};
pub use crate::stm32mp::peripherals::hdmi_cec::{
...
pub const HDMI_CEC: *const RegisterBlock = 0x40016000 as *const _;
