...
pub use crate::stm32mp::peripherals::pwr::Instance;
pub use crate::stm32mp::peripherals::pwr::{RegisterBlock, ResetValues};
pub use crate::stm32mp::peripherals::pwr::{
    PWR_CR1, PWR_CR2, PWR_CR3, PWR_CSR1, PWR_ID, PWR_MCUCR, PWR_MCUWKUPENR, PWR_MPUCR,
    PWR_MPUWKUPENR, PWR_SID, PWR_VER, PWR_WKUPCR, PWR_WKUPFR,
};
