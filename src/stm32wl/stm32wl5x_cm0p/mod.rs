//! stm32ral module for stm32wl5x_cm0p
...
pub use super::instances::tzic;
pub use super::instances::tzsc;
...
pub struct Peripherals {
    ...
    pub TZIC: tzic::Instance,
    pub TZSC: tzsc::Instance,
...
impl Peripherals {
    pub unsafe fn steal() -> Self {
        Peripherals {
            ...
            TZIC: tzic::TZIC::steal(),
            TZSC: tzsc::TZSC::steal(),
