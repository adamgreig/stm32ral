...
pub mod C2CR3 {
    ...
    pub mod EIWUL {
        ...
        pub mod RW {
            ...
            /// 0b0: Internal wakeup line interrupt to CPU2 disabled
            pub const Disabled: u32 = 0b0;

            /// 0b1: Internal wakeup line interrupt to CPU2 enabled
            pub const Enabled: u32 = 0b1;
        }
    }
    ...
    pub mod EWRFIRQ {
        ...
        pub mod RW {
            ...
            /// 0b0: Radio IRQ\[2:0\] is disabled and does not trigger a wakeup from Standby event to CPU2.
            pub const Disabled: u32 = 0b0;

            /// 0b1: Radio IRQ\[2:0\] is enabled and triggers a wakeup from Standby event to CPU2.
            pub const Enabled: u32 = 0b1;
        }
    }
    ...
    pub mod EWRFBUSY {
        ...
        pub mod RW {
            ...
            /// 0b0: Radio Busy is disabled and does not trigger a wakeup from Standby event to CPU2 when a rising or a falling edge occurs
            pub const Disabled: u32 = 0b0;

            /// 0b1: Radio Busy is enabled and triggers a wakeup from Standby event to CPU2 when a rising or a falling edge occurs. The active edge is configured via the WRFBUSYP bit in PWR_CR4
            pub const Enabled: u32 = 0b1;
        }
    }
