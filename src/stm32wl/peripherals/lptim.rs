...
pub mod OR {
    ...
    pub mod OR_ {
        ...
        pub mod RW {
            ...
            /// 0b00: Input 1 is connected to I/O
            pub const IO: u32 = 0b00;

            /// 0b01: Input 1 is connected to COMP1_OUT
            pub const COMP1_OUT: u32 = 0b01;

            /// 0b10: Input 1 is connected to COMP2_OUT
            pub const COMP2_OUT: u32 = 0b10;

            /// 0b11: Input 1 is connected to COMP1_OUT OR COMP2_OUT
            pub const OR_COMP1_COMP2: u32 = 0b11;
        }
    }
}
