...
pub mod C2ACR {
    ...
    pub mod PRFTEN {
        ...
        pub mod RW {
            ...
            /// 0b0: CPU2 prefetch is disabled
            pub const Disabled: u32 = 0b0;

            /// 0b1: CPU2 prefetch is enabled
            pub const Enabled: u32 = 0b1;
        }
    }
    ...
    pub mod ICEN {
        ...
        pub mod RW {
            ...
            /// 0b0: CPU2 instruction cache is disabled
            pub const Disabled: u32 = 0b0;

            /// 0b1: CPU2 instruction cache is enabled
            pub const Enabled: u32 = 0b1;
        }
    }
    ...
    pub mod ICRST {
        ...
        pub mod RW {
            ...
            /// 0b0: CPU2 instruction cache is not reset
            pub const NotReset: u32 = 0b0;

            /// 0b1: CPU2 instruction cache is reset
            pub const Reset: u32 = 0b1;
        }
    }
    ...
    pub mod PES {
        ...
        pub mod RW {
            ...
            /// 0b1: Any new Flash program and erase operation is suspended until this bit is cleared. The PESD bit in FLASH_C2SR is set when PES bit in FLASH_C2ACR is set
            pub const Suspended: u32 = 0b1;
        }
    }
}
...
pub mod C2SR {
    ...
    pub mod PESD {
        ...
        pub mod R {
            ...
            /// 0b1: Any new Flash program and erase operation is suspended until this bit is cleared. This bit is set when at least one PES bit in FLASH_ACR or FLASH_C2ACR is set.
            pub const Suspended: u32 = 0b1;
        }
        /// Write-only values (empty)
        pub mod W {}
...
pub mod SFR {
    ...
    pub mod FSD {
        ...
        pub mod RW {
            ...
            /// 0b0: System and Flash memory secure
            pub const Secure: u32 = 0b0;

            /// 0b1: System and Flash memory non-secure
            pub const NonSecure: u32 = 0b1;
        }
    }
    ...
    pub mod DDS {
        ...
        pub mod RW {
            ...
            /// 0b0: CPU2 debug access enabled
            pub const Enabled: u32 = 0b0;

            /// 0b1: CPU2 debug access disabled
            pub const Disabled: u32 = 0b1;
        }
    }
    ...
    pub mod HDPAD {
        ...
        pub mod RW {
            ...
            /// 0b0: User Flash memory hide protection area enabled. HDPSA\[6:0\] contains the start address of the first 2-Kbyte page of the user Flash memory hide protection area
            pub const Enabled: u32 = 0b0;

            /// 0b1: User Flash memory hide protection area disabled
            pub const Disabled: u32 = 0b1;
        }
    }
    ...
    pub mod SUBGHSPISD {
        ...
        pub mod RW {
            ...
            /// 0b0: sub-GHz radio SPI security enabled
            pub const Enabled: u32 = 0b0;

            /// 0b1: sub-GHz radio SPI security disabled
            pub const Disabled: u32 = 0b1;
        }
    }
}
...
pub mod SRRVR {
    ...
    pub mod BRSD {
        ...
        pub mod RW {
            ...
            /// 0b0: SRAM2 is secure. SNBRSA\[4:0\] contains the start address of the first 1-Kbyte page of the secure backup SRAM2 area
            pub const Secure: u32 = 0b0;

            /// 0b1: SRAM2 is non-secure
            pub const NonSecure: u32 = 0b1;
        }
    }
    ...
    pub mod NBRSD {
        ...
        pub mod RW {
            ...
            /// 0b0: SRAM1 is secure. SNBRSA\[4:0\] contains the start address of the first 1-Kbyte page of the secure non-backup SRAM1 area
            pub const Secure: u32 = 0b0;

            /// 0b1: SRAM1 is non-secure
            pub const NonSecure: u32 = 0b1;
        }
    }
    ...
    pub mod C2OPT {
        ...
        pub mod RW {
            ...
            /// 0b0: SBRV offset addresses SRAM1 or SRAM2, from start address 0x2000_0000 + SBRV
            pub const SRAM: u32 = 0b0;

            /// 0b1: SBRV offset addresses the Flash memory, from start address 0x0800_0000 + SBRV
            pub const Flash: u32 = 0b1;
        }
    }
}
#[repr(C)]
