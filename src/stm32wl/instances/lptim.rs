...
pub use crate::stm32wl::peripherals::lptim::Instance;
pub use crate::stm32wl::peripherals::lptim::{RegisterBlock, ResetValues};
pub use crate::stm32wl::peripherals::lptim::{ARR, CFGR, CMP, CNT, CR, ICR, IER, ISR, OR, RCR};
