...
pub use crate::stm32wl::peripherals::gpioh::Instance;
pub use crate::stm32wl::peripherals::gpioh::{RegisterBlock, ResetValues};
pub use crate::stm32wl::peripherals::gpioh::{
