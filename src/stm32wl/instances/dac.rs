...
pub use crate::stm32wl::peripherals::dac::Instance;
pub use crate::stm32wl::peripherals::dac::{RegisterBlock, ResetValues};
pub use crate::stm32wl::peripherals::dac::{
    CCR, CR, DHR12L1, DHR12LD, DHR12R1, DHR12RD, DHR8R1, DHR8RD, DOR1, MCR, SHHR, SHRR, SHSR1, SR,
    SWTRGR,
};
