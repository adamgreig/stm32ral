...
pub use crate::stm32wl::peripherals::aes::Instance;
pub use crate::stm32wl::peripherals::aes::{RegisterBlock, ResetValues};
pub use crate::stm32wl::peripherals::aes::{
...
pub const AES: *const RegisterBlock = 0x58001800 as *const _;
