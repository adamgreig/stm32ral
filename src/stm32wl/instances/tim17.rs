...
pub use crate::stm32wl::peripherals::tim17::Instance;
pub use crate::stm32wl::peripherals::tim17::{RegisterBlock, ResetValues};
pub use crate::stm32wl::peripherals::tim17::{
    AF1, ARR, BDTR, CCER, CCMR1, CCR1, CNT, CR1, CR2, DCR, DIER, DMAR, EGR, OR1, PSC, RCR, SR,
    TISEL,
};
