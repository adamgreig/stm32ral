...
pub use crate::stm32wl::peripherals::syscfg::Instance;
pub use crate::stm32wl::peripherals::syscfg::{RegisterBlock, ResetValues};
pub use crate::stm32wl::peripherals::syscfg::{
    C2IMR1, C2IMR2, CFGR1, CFGR2, EXTICR1, EXTICR2, EXTICR3, EXTICR4, IMR1, IMR2, MEMRMP, RFDCR,
    SCSR, SKR, SWPR,
};
