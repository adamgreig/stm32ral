...
pub use crate::stm32wl::peripherals::comp::Instance;
pub use crate::stm32wl::peripherals::comp::{RegisterBlock, ResetValues};
pub use crate::stm32wl::peripherals::comp::{COMP1_CSR, COMP2_CSR};
