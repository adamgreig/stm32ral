...
pub use crate::stm32wl::peripherals::scb_actrl::Instance;
pub use crate::stm32wl::peripherals::scb_actrl::ACTRL;
pub use crate::stm32wl::peripherals::scb_actrl::{RegisterBlock, ResetValues};
