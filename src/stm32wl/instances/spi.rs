...
pub use crate::stm32wl::peripherals::spi::Instance;
pub use crate::stm32wl::peripherals::spi::{RegisterBlock, ResetValues};
pub use crate::stm32wl::peripherals::spi::{
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const SPI3: *const RegisterBlock = 0x58010000 as *const _;
