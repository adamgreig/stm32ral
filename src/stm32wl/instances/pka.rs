...
pub use crate::stm32wl::peripherals::pka::Instance;
pub use crate::stm32wl::peripherals::pka::{RegisterBlock, ResetValues};
pub use crate::stm32wl::peripherals::pka::{CLRFR, CR, SR};
...
pub const PKA: *const RegisterBlock = 0x58002000 as *const _;
