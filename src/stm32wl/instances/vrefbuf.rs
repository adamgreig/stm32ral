...
pub use crate::stm32wl::peripherals::vrefbuf::Instance;
pub use crate::stm32wl::peripherals::vrefbuf::{RegisterBlock, ResetValues};
pub use crate::stm32wl::peripherals::vrefbuf::{CCR, CSR};
