...
pub use crate::stm32wl::peripherals::rtc::Instance;
pub use crate::stm32wl::peripherals::rtc::{RegisterBlock, ResetValues};
pub use crate::stm32wl::peripherals::rtc::{
    ALRABINR, ALRBBINR, ALRMAR, ALRMASSR, ALRMBR, ALRMBSSR, CALR, CR, DR, ICSR, MISR, PRER, SCR,
    SHIFTR, SR, SSR, TR, TSDR, TSSSR, TSTR, WPR, WUTR,
};
