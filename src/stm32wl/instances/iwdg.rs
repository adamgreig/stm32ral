...
pub use crate::stm32wl::peripherals::iwdg::Instance;
pub use crate::stm32wl::peripherals::iwdg::{RegisterBlock, ResetValues};
pub use crate::stm32wl::peripherals::iwdg::{KR, PR, RLR, SR};
