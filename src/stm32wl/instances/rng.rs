...
pub use crate::stm32wl::peripherals::rng::Instance;
pub use crate::stm32wl::peripherals::rng::{RegisterBlock, ResetValues};
pub use crate::stm32wl::peripherals::rng::{CR, DR, HTCR, SR};
