...
pub use crate::stm32wl::peripherals::exti::Instance;
pub use crate::stm32wl::peripherals::exti::{RegisterBlock, ResetValues};
pub use crate::stm32wl::peripherals::exti::{
    C1EMR1, C1EMR2, C1IMR1, C1IMR2, C2EMR1, C2EMR2, C2IMR1, C2IMR2, FTSR1, FTSR2, PR1, PR2, RTSR1,
    RTSR2, SWIER1, SWIER2,
};
