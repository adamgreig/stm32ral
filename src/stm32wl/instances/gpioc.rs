...
pub use crate::stm32wl::peripherals::gpioc::Instance;
pub use crate::stm32wl::peripherals::gpioc::{RegisterBlock, ResetValues};
pub use crate::stm32wl::peripherals::gpioc::{
