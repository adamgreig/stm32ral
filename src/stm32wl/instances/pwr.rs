...
pub use crate::stm32wl::peripherals::pwr::Instance;
pub use crate::stm32wl::peripherals::pwr::{RegisterBlock, ResetValues};
pub use crate::stm32wl::peripherals::pwr::{
    C2CR1, C2CR3, CR1, CR2, CR3, CR4, CR5, EXTSCR, PDCRA, PDCRB, PDCRC, PDCRH, PUCRA, PUCRB, PUCRC,
    PUCRH, RSSCMDR, SCR, SECCFGR, SR1, SR2, SUBGHZSPICR,
};
