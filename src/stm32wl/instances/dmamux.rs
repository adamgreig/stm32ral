...
pub use crate::stm32wl::peripherals::dmamux::Instance;
pub use crate::stm32wl::peripherals::dmamux::{RegisterBlock, ResetValues};
pub use crate::stm32wl::peripherals::dmamux::{
    C0CR, C10CR, C11CR, C12CR, C13CR, C1CR, C2CR, C3CR, C4CR, C5CR, C6CR, C7CR, C8CR, C9CR, CCFR,
