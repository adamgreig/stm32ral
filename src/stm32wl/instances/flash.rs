...
pub use crate::stm32wl::peripherals::flash::Instance;
pub use crate::stm32wl::peripherals::flash::{RegisterBlock, ResetValues};
pub use crate::stm32wl::peripherals::flash::{
    ACR, ACR2, C2ACR, C2CR, C2SR, CR, ECCR, IPCCBR, KEYR, OPTKEYR, OPTR, PCROP1AER, PCROP1ASR,
    PCROP1BER, PCROP1BSR, SFR, SR, SRRVR, WRP1AR, WRP1BR,
};
