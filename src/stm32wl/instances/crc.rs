...
pub use crate::stm32wl::peripherals::crc::Instance;
pub use crate::stm32wl::peripherals::crc::{RegisterBlock, ResetValues};
pub use crate::stm32wl::peripherals::crc::{CR, DR, IDR, INIT, POL};
