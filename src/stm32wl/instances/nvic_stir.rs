...
pub use crate::stm32wl::peripherals::nvic_stir::Instance;
pub use crate::stm32wl::peripherals::nvic_stir::STIR;
pub use crate::stm32wl::peripherals::nvic_stir::{RegisterBlock, ResetValues};
