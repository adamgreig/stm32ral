...
pub use crate::stm32wl::peripherals::wwdg::Instance;
pub use crate::stm32wl::peripherals::wwdg::{RegisterBlock, ResetValues};
pub use crate::stm32wl::peripherals::wwdg::{CFR, CR, SR};
