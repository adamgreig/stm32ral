...
pub use crate::stm32wl::peripherals::lptim1::Instance;
pub use crate::stm32wl::peripherals::lptim1::{RegisterBlock, ResetValues};
pub use crate::stm32wl::peripherals::lptim1::{ARR, CFGR, CMP, CNT, CR, ICR, IER, ISR, OR, RCR};
