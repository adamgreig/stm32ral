...
/// Access functions for the AES1 peripheral instance
pub mod AES1 {
    ...
    /// Reset values for each field in AES1
    ...
    #[no_mangle]
    static mut AES1_TAKEN: bool = false;
    ...
    /// Release exclusive access to AES1
    ///
    ...
    pub fn release(inst: Instance) {
        external_cortex_m::interrupt::free(|_| unsafe {
            if AES1_TAKEN && inst.addr == INSTANCE.addr {
                AES1_TAKEN = false;
            } else {
...
pub const AES1: *const RegisterBlock = 0x50060000 as *const _;
