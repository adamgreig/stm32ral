...
pub mod ACLRFR {
    ...
    pub use super::BCLRFR::CNRDY;
    pub use super::BCLRFR::LFSDET;
    pub use super::BCLRFR::MUTEDET;
    pub use super::BCLRFR::OVRUDR;
    pub use super::BCLRFR::WCKCFG;
}
...
pub mod PDMDLY {
    ...
    /// Delay line for second microphone of pair 1
    pub mod DLYM1R {
        /// Offset (4 bits)
        pub const offset: u32 = 4;
        /// Mask (3 bits: 0b111 << 4)
    ...
    /// Delay line for first microphone of pair 1
    pub mod DLYM1L {
        /// Offset (0 bits)
        pub const offset: u32 = 0;
        /// Mask (3 bits: 0b111 << 0)
