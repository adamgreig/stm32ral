...
pub use crate::stm32l0::peripherals::rng::Instance;
pub use crate::stm32l0::peripherals::rng::{RegisterBlock, ResetValues};
pub use crate::stm32l0::peripherals::rng::{CR, DR, SR};
