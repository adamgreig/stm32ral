...
pub use crate::stm32l0::peripherals::crc::Instance;
pub use crate::stm32l0::peripherals::crc::{RegisterBlock, ResetValues};
pub use crate::stm32l0::peripherals::crc::{CR, DR, IDR, INIT, POL};
