...
pub use crate::stm32l0::peripherals::pwr::Instance;
pub use crate::stm32l0::peripherals::pwr::{RegisterBlock, ResetValues};
pub use crate::stm32l0::peripherals::pwr::{CR, CSR};
