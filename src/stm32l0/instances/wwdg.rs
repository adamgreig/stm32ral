...
pub use crate::stm32l0::peripherals::wwdg::Instance;
pub use crate::stm32l0::peripherals::wwdg::{RegisterBlock, ResetValues};
pub use crate::stm32l0::peripherals::wwdg::{CFR, CR, SR};
