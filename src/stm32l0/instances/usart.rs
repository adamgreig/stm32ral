...
pub use crate::stm32l0::peripherals::usart2::Instance;
pub use crate::stm32l0::peripherals::usart2::{RegisterBlock, ResetValues};
pub use crate::stm32l0::peripherals::usart2::{
