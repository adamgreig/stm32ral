...
pub use stm32l0::peripherals::usart::Instance;
pub use stm32l0::peripherals::usart::{RegisterBlock, ResetValues};
pub use stm32l0::peripherals::usart::{BRR, CR1, CR2, CR3, GTPR, ICR, ISR, RDR, RQR, RTOR, TDR};
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const USART4: *const RegisterBlock = 0x40004c00 as *const _;
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const USART5: *const RegisterBlock = 0x40005000 as *const _;
