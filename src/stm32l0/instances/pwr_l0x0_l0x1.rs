...
//! Power control
//!
//! Used by: stm32l0x0, stm32l0x1

#[cfg(not(feature = "nosync"))]
pub use crate::stm32l0::peripherals::pwr_v1::Instance;
pub use crate::stm32l0::peripherals::pwr_v1::{RegisterBlock, ResetValues};
pub use crate::stm32l0::peripherals::pwr_v1::{CR, CSR};
