...
pub use crate::stm32l0::peripherals::dbg::Instance;
pub use crate::stm32l0::peripherals::dbg::{RegisterBlock, ResetValues};
pub use crate::stm32l0::peripherals::dbg::{APB1_FZ, APB2_FZ, CR, IDCODE};
