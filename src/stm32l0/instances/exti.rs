...
pub use stm32l0::peripherals::exti::Instance;
pub use stm32l0::peripherals::exti::{RegisterBlock, ResetValues};
pub use stm32l0::peripherals::exti::{EMR, FTSR, IMR, PR, RTSR, SWIER};
