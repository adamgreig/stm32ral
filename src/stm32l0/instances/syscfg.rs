...
pub use crate::stm32l0::peripherals::syscfg::Instance;
pub use crate::stm32l0::peripherals::syscfg::{RegisterBlock, ResetValues};
pub use crate::stm32l0::peripherals::syscfg::{
