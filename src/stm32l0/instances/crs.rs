...
pub use crate::stm32l0::peripherals::crs::Instance;
pub use crate::stm32l0::peripherals::crs::{RegisterBlock, ResetValues};
pub use crate::stm32l0::peripherals::crs::{CFGR, CR, ICR, ISR};
