...
pub use crate::stm32l0::peripherals::dbgmcu::Instance;
pub use crate::stm32l0::peripherals::dbgmcu::{RegisterBlock, ResetValues};
pub use crate::stm32l0::peripherals::dbgmcu::{APB1_FZ, APB2_FZ, CR, IDCODE};
