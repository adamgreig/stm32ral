...
pub use stm32l0::peripherals::tim6::Instance;
pub use stm32l0::peripherals::tim6::{RegisterBlock, ResetValues};
pub use stm32l0::peripherals::tim6::{ARR, CNT, CR1, CR2, DIER, EGR, PSC, SR};
