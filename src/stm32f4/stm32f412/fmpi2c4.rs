...
/// Access functions for the FMPI2C4 peripheral instance
pub mod FMPI2C4 {
    #[cfg(not(feature = "nosync"))]
    ...
    /// Reset values for each field in FMPI2C4
    ...
    #[no_mangle]
    static mut FMPI2C4_TAKEN: bool = false;

    /// Safe access to FMPI2C4
    ///
    ...
    /// Release exclusive access to FMPI2C4
    ///
    ...
    pub fn release(inst: Instance) {
        external_cortex_m::interrupt::free(|_| unsafe {
            if FMPI2C4_TAKEN && inst.addr == INSTANCE.addr {
                FMPI2C4_TAKEN = false;
            } else {
...
pub const FMPI2C4: *const RegisterBlock = 0x40006000 as *const _;
