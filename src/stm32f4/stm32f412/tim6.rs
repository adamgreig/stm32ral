...
pub use crate::stm32f4::peripherals::tim6_v2::Instance;
pub use crate::stm32f4::peripherals::tim6_v2::{RegisterBlock, ResetValues};
pub use crate::stm32f4::peripherals::tim6_v2::{ARR, CNT, CR1, CR2, DIER, EGR, PSC, SR};
