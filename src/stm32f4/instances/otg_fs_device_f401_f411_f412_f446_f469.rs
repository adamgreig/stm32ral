...
pub use stm32f4::peripherals::otg_fs_device_v1::Instance;
pub use stm32f4::peripherals::otg_fs_device_v1::{RegisterBlock, ResetValues};
pub use stm32f4::peripherals::otg_fs_device_v1::{
