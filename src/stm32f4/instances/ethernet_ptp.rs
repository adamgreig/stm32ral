...
pub use stm32f4::peripherals::ethernet_ptp::Instance;
pub use stm32f4::peripherals::ethernet_ptp::{RegisterBlock, ResetValues};
pub use stm32f4::peripherals::ethernet_ptp::{
