...
pub use crate::stm32f4::peripherals::otg_fs_host::Instance;
pub use crate::stm32f4::peripherals::otg_fs_host::{RegisterBlock, ResetValues};
pub use crate::stm32f4::peripherals::otg_fs_host::{
