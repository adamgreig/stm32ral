...
pub use crate::stm32f4::peripherals::dbgmcu_v3::Instance;
pub use crate::stm32f4::peripherals::dbgmcu_v3::{RegisterBlock, ResetValues};
pub use crate::stm32f4::peripherals::dbgmcu_v3::{APB1_FZ, APB2_FZ, CR, IDCODE};
