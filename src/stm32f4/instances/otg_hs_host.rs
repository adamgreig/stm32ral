...
pub use stm32f4::peripherals::otg_hs_host::Instance;
pub use stm32f4::peripherals::otg_hs_host::{RegisterBlock, ResetValues};
pub use stm32f4::peripherals::otg_hs_host::{
