...
pub use stm32f4::peripherals::otg_fs_device_v2::Instance;
pub use stm32f4::peripherals::otg_fs_device_v2::{RegisterBlock, ResetValues};
pub use stm32f4::peripherals::otg_fs_device_v2::{
