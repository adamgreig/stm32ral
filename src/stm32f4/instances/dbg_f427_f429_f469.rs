...
pub use stm32f4::peripherals::dbg_v3::Instance;
pub use stm32f4::peripherals::dbg_v3::{RegisterBlock, ResetValues};
pub use stm32f4::peripherals::dbg_v3::{DBGMCU_APB1_FZ, DBGMCU_APB2_FZ, DBGMCU_CR, DBGMCU_IDCODE};
