...
pub use crate::stm32f4::peripherals::exti::Instance;
pub use crate::stm32f4::peripherals::exti::{RegisterBlock, ResetValues};
pub use crate::stm32f4::peripherals::exti::{EMR, FTSR, IMR, PR, RTSR, SWIER};
