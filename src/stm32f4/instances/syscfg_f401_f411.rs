...
pub use crate::stm32f4::peripherals::syscfg_v1::Instance;
pub use crate::stm32f4::peripherals::syscfg_v1::{RegisterBlock, ResetValues};
pub use crate::stm32f4::peripherals::syscfg_v1::{
