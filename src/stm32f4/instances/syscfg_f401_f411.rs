...
pub use stm32f4::peripherals::syscfg_v1::Instance;
pub use stm32f4::peripherals::syscfg_v1::{RegisterBlock, ResetValues};
pub use stm32f4::peripherals::syscfg_v1::{CMPCR, EXTICR1, EXTICR2, EXTICR3, EXTICR4, MEMRM, PMC};
