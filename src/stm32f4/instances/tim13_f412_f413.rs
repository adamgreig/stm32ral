...
pub use stm32f4::peripherals::tim13::Instance;
pub use stm32f4::peripherals::tim13::{RegisterBlock, ResetValues};
pub use stm32f4::peripherals::tim13::{ARR, CCER, CCMR1, CCR1, CNT, CR1, DIER, EGR, PSC, SR};
