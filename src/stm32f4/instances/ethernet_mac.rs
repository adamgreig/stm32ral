...
pub use stm32f4::peripherals::ethernet_mac::Instance;
pub use stm32f4::peripherals::ethernet_mac::{RegisterBlock, ResetValues};
pub use stm32f4::peripherals::ethernet_mac::{
