...
pub use crate::stm32f4::peripherals::adc_common_v3::Instance;
pub use crate::stm32f4::peripherals::adc_common_v3::{RegisterBlock, ResetValues};
pub use crate::stm32f4::peripherals::adc_common_v3::{CCR, CSR};
