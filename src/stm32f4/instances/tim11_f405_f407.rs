...
pub use crate::stm32f4::peripherals::tim11_v2::Instance;
pub use crate::stm32f4::peripherals::tim11_v2::{RegisterBlock, ResetValues};
pub use crate::stm32f4::peripherals::tim11_v2::{
