...
pub use crate::stm32f4::peripherals::pwr_v3::Instance;
pub use crate::stm32f4::peripherals::pwr_v3::{RegisterBlock, ResetValues};
pub use crate::stm32f4::peripherals::pwr_v3::{CR, CSR};
