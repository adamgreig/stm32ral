...
pub use crate::stm32f4::peripherals::ethernet_mmc::Instance;
pub use crate::stm32f4::peripherals::ethernet_mmc::{RegisterBlock, ResetValues};
pub use crate::stm32f4::peripherals::ethernet_mmc::{
