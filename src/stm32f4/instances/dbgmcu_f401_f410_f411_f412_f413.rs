...
pub use stm32f4::peripherals::dbgmcu_v1::Instance;
pub use stm32f4::peripherals::dbgmcu_v1::{RegisterBlock, ResetValues};
pub use stm32f4::peripherals::dbgmcu_v1::{APB1_FZ, APB2_FZ, CR, IDCODE};
