...
pub use stm32f4::peripherals::otg_fs_global_v2::Instance;
pub use stm32f4::peripherals::otg_fs_global_v2::{RegisterBlock, ResetValues};
pub use stm32f4::peripherals::otg_fs_global_v2::{
    ...
    FS_GUSBCFG, FS_HPTXFSIZ, GRXSTSP,
};
