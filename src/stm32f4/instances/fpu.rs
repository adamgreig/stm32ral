...
pub use crate::stm32f4::peripherals::fpu::Instance;
pub use crate::stm32f4::peripherals::fpu::{RegisterBlock, ResetValues};
pub use crate::stm32f4::peripherals::fpu::{FPCAR, FPCCR, FPSCR};
