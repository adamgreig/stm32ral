...
pub use crate::stm32f4::peripherals::crc::Instance;
pub use crate::stm32f4::peripherals::crc::{RegisterBlock, ResetValues};
pub use crate::stm32f4::peripherals::crc::{CR, DR, IDR};
