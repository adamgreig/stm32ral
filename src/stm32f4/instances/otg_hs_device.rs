...
pub use crate::stm32f4::peripherals::otg_hs_device::Instance;
pub use crate::stm32f4::peripherals::otg_hs_device::{RegisterBlock, ResetValues};
pub use crate::stm32f4::peripherals::otg_hs_device::{
    ...
    OTG_HS_DIEPCTL5, OTG_HS_DIEPCTL6, OTG_HS_DIEPCTL7, OTG_HS_DIEPDMA1, OTG_HS_DIEPDMA2,
    OTG_HS_DIEPDMA3, OTG_HS_DIEPDMA4, OTG_HS_DIEPDMA5, OTG_HS_DIEPEACHMSK1, OTG_HS_DIEPEMPMSK,
    ...
    OTG_HS_DOEPCTL0, OTG_HS_DOEPCTL1, OTG_HS_DOEPCTL2, OTG_HS_DOEPCTL3, OTG_HS_DOEPEACHMSK1,
    OTG_HS_DOEPINT0, OTG_HS_DOEPINT1, OTG_HS_DOEPINT2, OTG_HS_DOEPINT3, OTG_HS_DOEPINT4,
    OTG_HS_DOEPINT5, OTG_HS_DOEPINT6, OTG_HS_DOEPINT7, OTG_HS_DOEPMSK, OTG_HS_DOEPTSIZ0,
    OTG_HS_DOEPTSIZ1, OTG_HS_DOEPTSIZ2, OTG_HS_DOEPTSIZ3, OTG_HS_DOEPTSIZ4, OTG_HS_DSTS,
    OTG_HS_DTHRCTL, OTG_HS_DTXFSTS0, OTG_HS_DTXFSTS1, OTG_HS_DTXFSTS2, OTG_HS_DTXFSTS3,
    OTG_HS_DTXFSTS4, OTG_HS_DTXFSTS5, OTG_HS_DVBUSDIS, OTG_HS_DVBUSPULSE,
};
