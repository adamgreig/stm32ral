...
pub mod DBGMCU_APB1_FZ {
    ...
    pub mod DBG_J2C1_SMBUS_TIMEOUT {
        /// Offset (21 bits)
    ...
    pub mod DBG_J2C2_SMBUS_TIMEOUT {
        /// Offset (22 bits)
    ...
    pub mod DBG_I2CFMP_SMBUS_TIMEOUT {
        /// Offset (24 bits)
...
pub struct RegisterBlock {
    /// IDCODE
    pub DBGMCU_IDCODE: RORegister<u32>,

    /// Control Register
    pub DBGMCU_CR: RWRegister<u32>,

    /// Debug MCU APB1 Freeze registe
    pub DBGMCU_APB1_FZ: RWRegister<u32>,

    /// Debug MCU APB2 Freeze registe
    pub DBGMCU_APB2_FZ: RWRegister<u32>,
}
