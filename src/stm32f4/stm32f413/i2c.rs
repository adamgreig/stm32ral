...
pub use stm32f4::peripherals::i2c_v2::Instance;
pub use stm32f4::peripherals::i2c_v2::{RegisterBlock, ResetValues};
pub use stm32f4::peripherals::i2c_v2::{CCR, CR1, CR2, DR, FLTR, OAR1, OAR2, SR1, SR2, TRISE};
