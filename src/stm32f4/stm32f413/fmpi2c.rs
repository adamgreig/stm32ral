...
pub mod FMPI2C {
    ...
    /// Reset values for each field in FMPI2C
    ...
    #[no_mangle]
    static mut FMPI2C_TAKEN: bool = false;

    /// Safe access to FMPI2C
    ///
    ...
    /// Release exclusive access to FMPI2C
    ///
    ...
    pub fn release(inst: Instance) {
        external_cortex_m::interrupt::free(|_| unsafe {
            if FMPI2C_TAKEN && inst.addr == INSTANCE.addr {
                FMPI2C_TAKEN = false;
            } else {
...
pub const FMPI2C: *const RegisterBlock = 0x40006000 as *const _;
