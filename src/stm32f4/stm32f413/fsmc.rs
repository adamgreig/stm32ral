...
/// BTR3
pub mod BTR3 {
    pub use super::BTR2::ACCMOD;
    pub use super::BTR2::ADDHLD;
    pub use super::BTR2::ADDSET;
    pub use super::BTR2::BUSTURN;
    pub use super::BTR2::CLKDIV;
    pub use super::BTR2::DATAST;
    pub use super::BTR2::DATLAT;
}

/// BCR4
pub mod BCR4 {
    pub use super::BCR3::ASYNCWAIT;
    pub use super::BCR3::BURSTEN;
    pub use super::BCR3::CBURSTRW;
    pub use super::BCR3::CCLKEN;
    pub use super::BCR3::CPSIZE;
    pub use super::BCR3::EXTMOD;
    pub use super::BCR3::FACCEN;
    pub use super::BCR3::MBKEN;
    pub use super::BCR3::MTYP;
    pub use super::BCR3::MUXEN;
    pub use super::BCR3::MWID;
    pub use super::BCR3::WAITCFG;
    pub use super::BCR3::WAITEN;
    pub use super::BCR3::WAITPOL;
    pub use super::BCR3::WFDIS;
    pub use super::BCR3::WREN;
}
