...
pub use crate::stm32f0::peripherals::syscfg::Instance;
pub use crate::stm32f0::peripherals::syscfg::{RegisterBlock, ResetValues};
pub use crate::stm32f0::peripherals::syscfg::{CFGR1, CFGR2, EXTICR1, EXTICR2, EXTICR3, EXTICR4};
