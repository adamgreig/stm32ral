...
pub use crate::stm32f0::peripherals::stk::Instance;
pub use crate::stm32f0::peripherals::stk::{RegisterBlock, ResetValues};
pub use crate::stm32f0::peripherals::stk::{CALIB, CSR, CVR, RVR};
