...
pub use crate::stm32f0::peripherals::pwr::Instance;
pub use crate::stm32f0::peripherals::pwr::{RegisterBlock, ResetValues};
pub use crate::stm32f0::peripherals::pwr::{CR, CSR};
