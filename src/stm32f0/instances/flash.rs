...
pub use stm32f0::peripherals::flash::Instance;
pub use stm32f0::peripherals::flash::{RegisterBlock, ResetValues};
pub use stm32f0::peripherals::flash::{ACR, AR, CR, KEYR, OBR, OPTKEYR, SR, WRPR};
