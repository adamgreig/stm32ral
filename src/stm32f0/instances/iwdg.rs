...
pub use crate::stm32f0::peripherals::iwdg::Instance;
pub use crate::stm32f0::peripherals::iwdg::{RegisterBlock, ResetValues};
pub use crate::stm32f0::peripherals::iwdg::{KR, PR, RLR, SR, WINR};
