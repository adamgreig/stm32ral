...
pub use crate::stm32f0::peripherals::comp::Instance;
pub use crate::stm32f0::peripherals::comp::CSR;
pub use crate::stm32f0::peripherals::comp::{RegisterBlock, ResetValues};
...
pub mod COMP {
    ...
    pub const reset: ResetValues = ResetValues { CSR: 0x00000000 };
