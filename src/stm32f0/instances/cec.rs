...
pub use crate::stm32f0::peripherals::cec::Instance;
pub use crate::stm32f0::peripherals::cec::{RegisterBlock, ResetValues};
pub use crate::stm32f0::peripherals::cec::{CFGR, CR, IER, ISR, RXDR, TXDR};
