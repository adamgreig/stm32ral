...
//!
//! Used by: stm32f0x0, stm32f0x1, stm32f0x8
...
pub mod FTSR {
    pub use super::RTSR::TR0;
    pub use super::RTSR::TR1;
    pub use super::RTSR::TR10;
    pub use super::RTSR::TR11;
    pub use super::RTSR::TR12;
    pub use super::RTSR::TR13;
    pub use super::RTSR::TR14;
    pub use super::RTSR::TR15;
    pub use super::RTSR::TR16;
    pub use super::RTSR::TR17;
    pub use super::RTSR::TR19;
    pub use super::RTSR::TR2;
    pub use super::RTSR::TR3;
    pub use super::RTSR::TR4;
    pub use super::RTSR::TR5;
    pub use super::RTSR::TR6;
    pub use super::RTSR::TR7;
    pub use super::RTSR::TR8;
    pub use super::RTSR::TR9;
}
