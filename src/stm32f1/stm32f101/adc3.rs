...
pub mod CR2 {
    ...
    pub mod JEXTSEL {
        ...
        pub mod RW {
            ...
            /// 0b010: Timer 4 CC3 event
            pub const Tim4Cc3: u32 = 0b010;

            /// 0b011: Timer 8 CC2 event
            pub const Tim8Cc2: u32 = 0b011;

            /// 0b100: Timer 8 CC4 event
            pub const Tim8Cc4: u32 = 0b100;

            /// 0b101: Timer 5 TRGO event
            pub const Tim5Trgo: u32 = 0b101;

            /// 0b110: Timer 5 CC4 event
...
pub mod SMPR1 {
    ...
    pub mod SMPx_x {
        ...
        pub mod RW {
            ...
            /// 0b00000000000000000000000000000000: 1.5 ADC clock cycles
            pub const Cycles1_5: u32 = 0b00000000000000000000000000000000;

            /// 0b00000000000000000000000000000001: 7.5 ADC clock cycles
            pub const Cycles7_5: u32 = 0b00000000000000000000000000000001;

            /// 0b00000000000000000000000000000010: 13.5 ADC clock cycles
            pub const Cycles13_5: u32 = 0b00000000000000000000000000000010;

            /// 0b00000000000000000000000000000011: 28.5 ADC clock cycles
            pub const Cycles28_5: u32 = 0b00000000000000000000000000000011;

            /// 0b00000000000000000000000000000100: 41.5 ADC clock cycles
            pub const Cycles41_5: u32 = 0b00000000000000000000000000000100;

            /// 0b00000000000000000000000000000101: 55.5 ADC clock cycles
            pub const Cycles55_5: u32 = 0b00000000000000000000000000000101;

            /// 0b00000000000000000000000000000110: 71.5 ADC clock cycles
            pub const Cycles71_5: u32 = 0b00000000000000000000000000000110;

            /// 0b00000000000000000000000000000111: 239.5 ADC clock cycles
            pub const Cycles239_5: u32 = 0b00000000000000000000000000000111;
        }
    }
}
