...
pub use crate::stm32f1::peripherals::flash::Instance;
pub use crate::stm32f1::peripherals::flash::{RegisterBlock, ResetValues};
pub use crate::stm32f1::peripherals::flash::{ACR, AR, CR, KEYR, OBR, OPTKEYR, SR, WRPR};
