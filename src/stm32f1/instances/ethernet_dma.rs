...
pub use stm32f1::peripherals::ethernet_dma::Instance;
pub use stm32f1::peripherals::ethernet_dma::{RegisterBlock, ResetValues};
pub use stm32f1::peripherals::ethernet_dma::{
