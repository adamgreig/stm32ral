...
pub use crate::stm32f1::peripherals::fsmc_v1::Instance;
pub use crate::stm32f1::peripherals::fsmc_v1::{RegisterBlock, ResetValues};
pub use crate::stm32f1::peripherals::fsmc_v1::{
