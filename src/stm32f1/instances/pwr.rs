...
pub use crate::stm32f1::peripherals::pwr::Instance;
pub use crate::stm32f1::peripherals::pwr::{RegisterBlock, ResetValues};
pub use crate::stm32f1::peripherals::pwr::{CR, CSR};
