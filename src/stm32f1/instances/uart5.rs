...
pub use stm32f1::peripherals::uart5::Instance;
pub use stm32f1::peripherals::uart5::{RegisterBlock, ResetValues};
pub use stm32f1::peripherals::uart5::{BRR, CR1, CR2, CR3, DR, SR};
