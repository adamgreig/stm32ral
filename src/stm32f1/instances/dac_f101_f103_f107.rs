...
pub use crate::stm32f1::peripherals::dac_v2::Instance;
pub use crate::stm32f1::peripherals::dac_v2::{RegisterBlock, ResetValues};
pub use crate::stm32f1::peripherals::dac_v2::{
