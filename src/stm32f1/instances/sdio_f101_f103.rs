...
pub use stm32f1::peripherals::sdio_v1::Instance;
pub use stm32f1::peripherals::sdio_v1::{RegisterBlock, ResetValues};
pub use stm32f1::peripherals::sdio_v1::{
    ARG, CLKCR, CMD, DCOUNT, DCTRL, DLEN, DTIMER, FIFO, FIFOCNT, ICR, MASK, POWER, RESP2, RESP3,
    RESP4, RESPCMD, RESPI1, STA,
};
