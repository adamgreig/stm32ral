...
pub use crate::stm32f1::peripherals::nvic_stir::Instance;
pub use crate::stm32f1::peripherals::nvic_stir::STIR;
pub use crate::stm32f1::peripherals::nvic_stir::{RegisterBlock, ResetValues};
