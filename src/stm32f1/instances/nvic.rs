...
pub use crate::stm32f1::peripherals::nvic::Instance;
pub use crate::stm32f1::peripherals::nvic::{RegisterBlock, ResetValues};
pub use crate::stm32f1::peripherals::nvic::{
    IABR0, IABR1, ICER0, ICER1, ICPR0, ICPR1, IPR0, IPR1, IPR10, IPR11, IPR12, IPR13, IPR14, IPR2,
    IPR3, IPR4, IPR5, IPR6, IPR7, IPR8, IPR9, ISER0, ISER1, ISPR0, ISPR1,
};
