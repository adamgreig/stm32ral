...
pub use stm32f1::peripherals::exti::Instance;
pub use stm32f1::peripherals::exti::{RegisterBlock, ResetValues};
pub use stm32f1::peripherals::exti::{EMR, FTSR, IMR, PR, RTSR, SWIER};
