...
pub use crate::stm32f1::peripherals::stk::Instance;
pub use crate::stm32f1::peripherals::stk::{RegisterBlock, ResetValues};
pub use crate::stm32f1::peripherals::stk::{CALIB, CTRL, LOAD_, VAL};
