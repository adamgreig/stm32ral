...
pub mod WPCCR {
    pub use super::CCR::DCYC;
    pub use super::CCR::DHQC;
    pub use super::CCR::SSHIFT;
}

/// write timing configuration register
pub mod WPTCR {
    pub use super::TCR::INSTRUCTION;
}

/// write instruction register
pub mod WPIR {
    pub use super::IR::ALTERNATE;
}
...
/// WTCR
pub mod WTCR {
    pub use super::LPTR::ABDTR;
    pub use super::LPTR::ABMODE;
    pub use super::LPTR::ABSIZE;
    pub use super::LPTR::ADDTR;
    pub use super::LPTR::ADMODE;
    pub use super::LPTR::ADSIZE;
    pub use super::LPTR::DDTR;
    pub use super::LPTR::DMODE;
    pub use super::LPTR::DQSE;
    pub use super::LPTR::IDTR;
    pub use super::LPTR::IMODE;
    pub use super::LPTR::ISIZE;
}
