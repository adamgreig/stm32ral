...
pub mod CCR2 {
    ...
    /// Transfer error interupt enable
    pub mod TEIE {
        /// Offset (3 bits)
        pub const offset: u32 = 3;
        /// Mask (1 bit: 1 << 3)
    ...
    /// Current target memory of DMA transfer in double-bufer mode
    pub mod CT {
        /// Offset (16 bits)
        pub const offset: u32 = 16;
        /// Mask (1 bit: 1 << 16)
...
/// channel x configuration register
pub mod CCR6 {
    pub use super::CCR2::CIRC;
    pub use super::CCR2::CT;
    pub use super::CCR2::DBM;
    pub use super::CCR2::DIR;
    pub use super::CCR2::DSEC;
    pub use super::CCR2::EN;
    pub use super::CCR2::HTIE;
    pub use super::CCR2::MEM2MEM;
    pub use super::CCR2::MINC;
    pub use super::CCR2::MSIZE;
    pub use super::CCR2::NDT;
    pub use super::CCR2::PINC;
    pub use super::CCR2::PL;
    pub use super::CCR2::PRIV;
    pub use super::CCR2::PSIZE;
    pub use super::CCR2::SECM;
    pub use super::CCR2::SSEC;
    pub use super::CCR2::TCIE;
    pub use super::CCR2::TEIE;
}
...
/// channel x configuration register
pub mod CCR7 {
    pub use super::CCR4::CIRC;
    pub use super::CCR4::CT;
    pub use super::CCR4::DBM;
    pub use super::CCR4::DIR;
    pub use super::CCR4::DSEC;
    pub use super::CCR4::EN;
    pub use super::CCR4::HTIE;
    pub use super::CCR4::MEM2MEM;
    pub use super::CCR4::MINC;
    pub use super::CCR4::MSIZE;
    pub use super::CCR4::PINC;
    pub use super::CCR4::PL;
    pub use super::CCR4::PRIV;
    pub use super::CCR4::PSIZE;
    pub use super::CCR4::SECM;
    pub use super::CCR4::SSEC;
    pub use super::CCR4::TCIE;
    pub use super::CCR4::TEIE;
}
