...
pub use crate::stm32l5::peripherals::dbgmcu::Instance;
pub use crate::stm32l5::peripherals::dbgmcu::{RegisterBlock, ResetValues};
pub use crate::stm32l5::peripherals::dbgmcu::{APB1HFZR, APB1LFZR, APB2FZR, CR, IDCODE};
...
pub const DBGMCU: *const RegisterBlock = 0xe0044000 as *const _;
