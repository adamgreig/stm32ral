...
pub use crate::stm32l5::peripherals::lpuart1::Instance;
pub use crate::stm32l5::peripherals::lpuart1::{RegisterBlock, ResetValues};
pub use crate::stm32l5::peripherals::lpuart1::{
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const SEC_LPUART1: *const RegisterBlock = 0x50008000 as *const _;
