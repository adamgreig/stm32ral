...
pub use crate::stm32l5::peripherals::nvic_stir::Instance;
pub use crate::stm32l5::peripherals::nvic_stir::STIR;
pub use crate::stm32l5::peripherals::nvic_stir::{RegisterBlock, ResetValues};
