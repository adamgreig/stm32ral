...
pub use crate::stm32l5::peripherals::sec_gtzc_mpcbb1::Instance;
pub use crate::stm32l5::peripherals::sec_gtzc_mpcbb1::{RegisterBlock, ResetValues};
pub use crate::stm32l5::peripherals::sec_gtzc_mpcbb1::{
