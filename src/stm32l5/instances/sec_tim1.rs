...
pub use crate::stm32l5::peripherals::tim1::Instance;
pub use crate::stm32l5::peripherals::tim1::{
    CCMR3_Output, ARR, BDTR, CCER, CCMR1, CCMR2, CCR1, CCR2, CCR3, CCR4, CCR5, CCR6, CNT, CR1, CR2,
    DCR, DIER, DMAR, EGR, OR1, OR2, OR3, PSC, RCR, SMCR, SR,
};
pub use crate::stm32l5::peripherals::tim1::{RegisterBlock, ResetValues};
