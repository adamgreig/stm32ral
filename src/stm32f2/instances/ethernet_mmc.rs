...
pub use stm32f2::peripherals::ethernet_mmc::Instance;
pub use stm32f2::peripherals::ethernet_mmc::{RegisterBlock, ResetValues};
pub use stm32f2::peripherals::ethernet_mmc::{
