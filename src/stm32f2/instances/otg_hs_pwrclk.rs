...
pub use crate::stm32f2::peripherals::otg_hs_pwrclk::Instance;
pub use crate::stm32f2::peripherals::otg_hs_pwrclk::OTG_HS_PCGCR;
pub use crate::stm32f2::peripherals::otg_hs_pwrclk::{RegisterBlock, ResetValues};
