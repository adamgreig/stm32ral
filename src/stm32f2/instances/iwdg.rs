...
pub use crate::stm32f2::peripherals::iwdg::Instance;
pub use crate::stm32f2::peripherals::iwdg::{RegisterBlock, ResetValues};
pub use crate::stm32f2::peripherals::iwdg::{KR, PR, RLR, SR};
