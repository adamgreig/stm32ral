...
pub use stm32f2::peripherals::otg_fs_global::Instance;
pub use stm32f2::peripherals::otg_fs_global::{RegisterBlock, ResetValues};
pub use stm32f2::peripherals::otg_fs_global::{
