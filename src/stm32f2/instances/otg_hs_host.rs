...
pub use stm32f2::peripherals::otg_hs_host::Instance;
pub use stm32f2::peripherals::otg_hs_host::{RegisterBlock, ResetValues};
pub use stm32f2::peripherals::otg_hs_host::{
    OTG_HS_HAINT, OTG_HS_HAINTMSK, OTG_HS_HCCHAR0, OTG_HS_HCCHAR1, OTG_HS_HCCHAR10,
    OTG_HS_HCCHAR11, OTG_HS_HCCHAR2, OTG_HS_HCCHAR3, OTG_HS_HCCHAR4, OTG_HS_HCCHAR5,
    OTG_HS_HCCHAR6, OTG_HS_HCCHAR7, OTG_HS_HCCHAR8, OTG_HS_HCCHAR9, OTG_HS_HCDMA0, OTG_HS_HCDMA1,
    OTG_HS_HCDMA10, OTG_HS_HCDMA11, OTG_HS_HCDMA2, OTG_HS_HCDMA3, OTG_HS_HCDMA4, OTG_HS_HCDMA5,
    OTG_HS_HCDMA6, OTG_HS_HCDMA7, OTG_HS_HCDMA8, OTG_HS_HCDMA9, OTG_HS_HCFG, OTG_HS_HCINT0,
    OTG_HS_HCINT1, OTG_HS_HCINT10, OTG_HS_HCINT11, OTG_HS_HCINT2, OTG_HS_HCINT3, OTG_HS_HCINT4,
    OTG_HS_HCINT5, OTG_HS_HCINT6, OTG_HS_HCINT7, OTG_HS_HCINT8, OTG_HS_HCINT9, OTG_HS_HCINTMSK0,
    OTG_HS_HCINTMSK1, OTG_HS_HCINTMSK10, OTG_HS_HCINTMSK11, OTG_HS_HCINTMSK2, OTG_HS_HCINTMSK3,
    OTG_HS_HCINTMSK4, OTG_HS_HCINTMSK5, OTG_HS_HCINTMSK6, OTG_HS_HCINTMSK7, OTG_HS_HCINTMSK8,
    OTG_HS_HCINTMSK9, OTG_HS_HCSPLT0, OTG_HS_HCSPLT1, OTG_HS_HCSPLT10, OTG_HS_HCSPLT11,
    OTG_HS_HCSPLT2, OTG_HS_HCSPLT3, OTG_HS_HCSPLT4, OTG_HS_HCSPLT5, OTG_HS_HCSPLT6, OTG_HS_HCSPLT7,
    OTG_HS_HCSPLT8, OTG_HS_HCSPLT9, OTG_HS_HCTSIZ0, OTG_HS_HCTSIZ1, OTG_HS_HCTSIZ10,
    OTG_HS_HCTSIZ11, OTG_HS_HCTSIZ2, OTG_HS_HCTSIZ3, OTG_HS_HCTSIZ4, OTG_HS_HCTSIZ5,
    OTG_HS_HCTSIZ6, OTG_HS_HCTSIZ7, OTG_HS_HCTSIZ8, OTG_HS_HCTSIZ9, OTG_HS_HFIR, OTG_HS_HFNUM,
    OTG_HS_HPRT, OTG_HS_HPTXSTS,
};
