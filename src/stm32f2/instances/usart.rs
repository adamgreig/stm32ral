...
pub use crate::stm32f2::peripherals::usart::Instance;
pub use crate::stm32f2::peripherals::usart::{RegisterBlock, ResetValues};
pub use crate::stm32f2::peripherals::usart::{BRR, CR1, CR2, CR3, DR, GTPR, SR};
