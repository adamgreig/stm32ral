...
pub use stm32f2::peripherals::otg_hs_device::Instance;
pub use stm32f2::peripherals::otg_hs_device::{RegisterBlock, ResetValues};
pub use stm32f2::peripherals::otg_hs_device::{
