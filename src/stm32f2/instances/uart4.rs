...
pub use stm32f2::peripherals::uart4::Instance;
pub use stm32f2::peripherals::uart4::{RegisterBlock, ResetValues};
pub use stm32f2::peripherals::uart4::{BRR, CR1, CR2, CR3, DR, SR};
