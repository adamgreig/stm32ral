...
pub use crate::stm32f2::peripherals::syscfg::Instance;
pub use crate::stm32f2::peripherals::syscfg::{RegisterBlock, ResetValues};
pub use crate::stm32f2::peripherals::syscfg::{
