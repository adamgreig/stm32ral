...
pub use stm32f2::peripherals::syscfg::Instance;
pub use stm32f2::peripherals::syscfg::{RegisterBlock, ResetValues};
pub use stm32f2::peripherals::syscfg::{CMPCR, EXTICR1, EXTICR2, EXTICR3, EXTICR4, MEMRM, PMC};
