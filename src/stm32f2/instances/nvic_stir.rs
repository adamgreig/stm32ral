...
pub use crate::stm32f2::peripherals::nvic_stir::Instance;
pub use crate::stm32f2::peripherals::nvic_stir::STIR;
pub use crate::stm32f2::peripherals::nvic_stir::{RegisterBlock, ResetValues};
