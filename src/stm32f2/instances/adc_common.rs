...
pub use stm32f2::peripherals::adc_common::Instance;
pub use stm32f2::peripherals::adc_common::{RegisterBlock, ResetValues};
pub use stm32f2::peripherals::adc_common::{CCR, CDR, CSR};
