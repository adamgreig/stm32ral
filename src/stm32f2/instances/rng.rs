...
pub use crate::stm32f2::peripherals::rng::Instance;
pub use crate::stm32f2::peripherals::rng::{RegisterBlock, ResetValues};
pub use crate::stm32f2::peripherals::rng::{CR, DR, SR};
