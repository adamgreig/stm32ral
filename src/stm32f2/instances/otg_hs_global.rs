...
pub use stm32f2::peripherals::otg_hs_global::Instance;
pub use stm32f2::peripherals::otg_hs_global::{RegisterBlock, ResetValues};
pub use stm32f2::peripherals::otg_hs_global::{
