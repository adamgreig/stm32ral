...
pub use crate::stm32f2::peripherals::crc::Instance;
pub use crate::stm32f2::peripherals::crc::{RegisterBlock, ResetValues};
pub use crate::stm32f2::peripherals::crc::{CR, DR, IDR};
