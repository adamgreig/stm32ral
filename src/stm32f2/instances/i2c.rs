...
pub use crate::stm32f2::peripherals::i2c::Instance;
pub use crate::stm32f2::peripherals::i2c::{RegisterBlock, ResetValues};
pub use crate::stm32f2::peripherals::i2c::{CCR, CR1, CR2, DR, OAR1, OAR2, SR1, SR2, TRISE};
