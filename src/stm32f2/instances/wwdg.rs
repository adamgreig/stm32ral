...
pub use crate::stm32f2::peripherals::wwdg::Instance;
pub use crate::stm32f2::peripherals::wwdg::{RegisterBlock, ResetValues};
pub use crate::stm32f2::peripherals::wwdg::{CFR, CR, SR};
