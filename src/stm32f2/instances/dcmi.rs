...
pub use stm32f2::peripherals::dcmi::Instance;
pub use stm32f2::peripherals::dcmi::{RegisterBlock, ResetValues};
pub use stm32f2::peripherals::dcmi::{CR, CWSIZE, CWSTRT, DR, ESCR, ESUR, ICR, IER, MIS, RIS, SR};
