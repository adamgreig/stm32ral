...
pub use crate::stm32f2::peripherals::ethernet_ptp::Instance;
pub use crate::stm32f2::peripherals::ethernet_ptp::{RegisterBlock, ResetValues};
pub use crate::stm32f2::peripherals::ethernet_ptp::{
