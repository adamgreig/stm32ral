...
pub use crate::stm32f2::peripherals::ethernet_dma::Instance;
pub use crate::stm32f2::peripherals::ethernet_dma::{RegisterBlock, ResetValues};
pub use crate::stm32f2::peripherals::ethernet_dma::{
