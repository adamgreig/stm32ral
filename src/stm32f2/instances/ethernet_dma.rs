...
pub use stm32f2::peripherals::ethernet_dma::Instance;
pub use stm32f2::peripherals::ethernet_dma::{RegisterBlock, ResetValues};
pub use stm32f2::peripherals::ethernet_dma::{
