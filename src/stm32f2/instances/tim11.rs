...
pub use stm32f2::peripherals::tim10::Instance;
pub use stm32f2::peripherals::tim10::{RegisterBlock, ResetValues};
pub use stm32f2::peripherals::tim10::{ARR, CCER, CCMR1, CCR1, CNT, CR1, DIER, EGR, OR, PSC, SR};
