...
pub use stm32f2::peripherals::uart::Instance;
pub use stm32f2::peripherals::uart::{RegisterBlock, ResetValues};
pub use stm32f2::peripherals::uart::{BRR, CR1, CR2, CR3, DR, SR};
