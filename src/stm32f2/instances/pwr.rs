...
pub use crate::stm32f2::peripherals::pwr::Instance;
pub use crate::stm32f2::peripherals::pwr::{RegisterBlock, ResetValues};
pub use crate::stm32f2::peripherals::pwr::{CR, CSR};
