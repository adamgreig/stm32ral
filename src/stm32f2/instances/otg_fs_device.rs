...
pub use stm32f2::peripherals::otg_fs_device::Instance;
pub use stm32f2::peripherals::otg_fs_device::{RegisterBlock, ResetValues};
pub use stm32f2::peripherals::otg_fs_device::{
