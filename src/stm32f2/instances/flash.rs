...
pub use crate::stm32f2::peripherals::flash::Instance;
pub use crate::stm32f2::peripherals::flash::{RegisterBlock, ResetValues};
pub use crate::stm32f2::peripherals::flash::{ACR, CR, KEYR, OPTCR, OPTKEYR, SR};
