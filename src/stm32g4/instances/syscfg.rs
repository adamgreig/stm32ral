...
pub use crate::stm32g4::peripherals::syscfg::Instance;
pub use crate::stm32g4::peripherals::syscfg::{RegisterBlock, ResetValues};
pub use crate::stm32g4::peripherals::syscfg::{
