...
pub use crate::stm32g4::peripherals::mpu::Instance;
pub use crate::stm32g4::peripherals::mpu::{RegisterBlock, ResetValues};
pub use crate::stm32g4::peripherals::mpu::{CTRL, RASR, RBAR, RNR, TYPER};
...
pub const MPU: *const RegisterBlock = 0xe000e084 as *const _;
