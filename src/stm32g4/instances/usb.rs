...
pub use crate::stm32g4::peripherals::usb::Instance;
pub use crate::stm32g4::peripherals::usb::{RegisterBlock, ResetValues};
pub use crate::stm32g4::peripherals::usb::{
    BCDR, BTABLE, CNTR, DADDR, EP0R, EP1R, EP2R, EP3R, EP4R, EP5R, EP6R, EP7R, FNR, ISTR,
};
