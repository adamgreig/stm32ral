...
pub use crate::stm32g4::peripherals::tim6::Instance;
pub use crate::stm32g4::peripherals::tim6::{RegisterBlock, ResetValues};
pub use crate::stm32g4::peripherals::tim6::{ARR, CNT, CR1, CR2, DIER, EGR, PSC, SR};
