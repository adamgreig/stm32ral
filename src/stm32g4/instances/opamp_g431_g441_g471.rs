...
pub use crate::stm32g4::peripherals::opamp_v1::Instance;
pub use crate::stm32g4::peripherals::opamp_v1::{RegisterBlock, ResetValues};
pub use crate::stm32g4::peripherals::opamp_v1::{
    OPAMP1_CSR, OPAMP1_TCMR, OPAMP2_CSR, OPAMP2_TCMR, OPAMP3_CSR, OPAMP3_TCMR,
};
