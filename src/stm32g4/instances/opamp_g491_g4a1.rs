...
pub use crate::stm32g4::peripherals::opamp_v3::Instance;
pub use crate::stm32g4::peripherals::opamp_v3::{RegisterBlock, ResetValues};
pub use crate::stm32g4::peripherals::opamp_v3::{
    OPAMP1_CSR, OPAMP1_TCMR, OPAMP2_CSR, OPAMP2_TCMR, OPAMP3_CSR, OPAMP3_TCMR, OPAMP6_CSR,
    OPAMP6_TCMR,
};
