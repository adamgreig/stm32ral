...
pub use crate::stm32g4::peripherals::quadspi::Instance;
pub use crate::stm32g4::peripherals::quadspi::{RegisterBlock, ResetValues};
pub use crate::stm32g4::peripherals::quadspi::{
