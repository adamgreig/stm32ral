...
pub use crate::stm32g4::peripherals::stk::Instance;
pub use crate::stm32g4::peripherals::stk::{RegisterBlock, ResetValues};
pub use crate::stm32g4::peripherals::stk::{CALIB, CTRL, LOAD, VAL};
