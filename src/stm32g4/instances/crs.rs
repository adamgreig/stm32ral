...
pub use crate::stm32g4::peripherals::crs::Instance;
pub use crate::stm32g4::peripherals::crs::{RegisterBlock, ResetValues};
pub use crate::stm32g4::peripherals::crs::{CFGR, CR, ICR, ISR};
...
pub const CRS: *const RegisterBlock = 0x40002000 as *const _;
