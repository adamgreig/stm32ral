...
pub use crate::stm32g4::peripherals::hrtim_master::Instance;
pub use crate::stm32g4::peripherals::hrtim_master::{RegisterBlock, ResetValues};
pub use crate::stm32g4::peripherals::hrtim_master::{
    MCMP1R, MCMP2R, MCMP3R, MCMP4R, MCNTR, MCR, MDIER, MICR, MISR, MPER, MREP,
};
...
pub const HRTIM_Master: *const RegisterBlock = 0x40016800 as *const _;
