...
pub use crate::stm32g4::peripherals::dbgmcu::Instance;
pub use crate::stm32g4::peripherals::dbgmcu::{RegisterBlock, ResetValues};
pub use crate::stm32g4::peripherals::dbgmcu::{APB1H_FZ, APB1L_FZ, APB2_FZ, CR, IDCODE};
