...
pub use crate::stm32g4::peripherals::rng::Instance;
pub use crate::stm32g4::peripherals::rng::{RegisterBlock, ResetValues};
pub use crate::stm32g4::peripherals::rng::{CR, DR, SR};
