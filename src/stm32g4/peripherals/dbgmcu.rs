...
pub struct RegisterBlock {
    ...
    /// APB Low Freeze Register 1
    pub APB1L_FZ: RWRegister<u32>,

    /// APB Low Freeze Register 2
    pub APB1H_FZ: RWRegister<u32>,
