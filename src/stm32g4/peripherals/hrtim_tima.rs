...
pub mod CPT2ACR {
    ...
    pub use super::CPT1ACR::TF1RST;
    pub use super::CPT1ACR::TF1SET;
    pub use super::CPT1ACR::TFCMP1;
    pub use super::CPT1ACR::TFCMP2;
    pub use super::CPT1ACR::UDPCPT;
}
...
pub struct RegisterBlock {
    ...
    /// HRTIM Timerx Control Register 2
    pub TIMACR2: RWRegister<u32>,

    /// HRTIM Timerx External Event Filtering Register 3
    pub AEEFR3: RWRegister<u32>,
}
