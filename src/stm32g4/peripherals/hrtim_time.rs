...
pub mod SETE2R {
    pub use super::SETE1R::CMP1;
    pub use super::SETE1R::CMP2;
    pub use super::SETE1R::CMP3;
    pub use super::SETE1R::CMP4;
    pub use super::SETE1R::EXTEVNT1;
    pub use super::SETE1R::EXTEVNT10;
    pub use super::SETE1R::EXTEVNT2;
    pub use super::SETE1R::EXTEVNT3;
    pub use super::SETE1R::EXTEVNT4;
    pub use super::SETE1R::EXTEVNT5;
    pub use super::SETE1R::EXTEVNT6;
    pub use super::SETE1R::EXTEVNT7;
    pub use super::SETE1R::EXTEVNT8;
    pub use super::SETE1R::EXTEVNT9;
    pub use super::SETE1R::MSTCMP1;
    pub use super::SETE1R::MSTCMP2;
    pub use super::SETE1R::MSTCMP3;
    pub use super::SETE1R::MSTCMP4;
    pub use super::SETE1R::MSTPER;
    pub use super::SETE1R::PER;
    pub use super::SETE1R::RESYNC;
    pub use super::SETE1R::SST;
    pub use super::SETE1R::TIMEVNT1;
    pub use super::SETE1R::TIMEVNT2;
    pub use super::SETE1R::TIMEVNT3;
    pub use super::SETE1R::TIMEVNT4;
    pub use super::SETE1R::TIMEVNT5;
    pub use super::SETE1R::TIMEVNT6;
    pub use super::SETE1R::TIMEVNT7;
    pub use super::SETE1R::TIMEVNT8;
    pub use super::SETE1R::TIMEVNT9;
    pub use super::SETE1R::UPDATE;
}

/// Timerx Output2 Reset Register
pub mod RSTE2R {
    pub use super::RSTE1R::CMP1;
    pub use super::RSTE1R::CMP2;
    pub use super::RSTE1R::CMP3;
    pub use super::RSTE1R::CMP4;
    pub use super::RSTE1R::EXTEVNT1;
    pub use super::RSTE1R::EXTEVNT10;
    pub use super::RSTE1R::EXTEVNT2;
    pub use super::RSTE1R::EXTEVNT3;
    pub use super::RSTE1R::EXTEVNT4;
    pub use super::RSTE1R::EXTEVNT5;
    pub use super::RSTE1R::EXTEVNT6;
    pub use super::RSTE1R::EXTEVNT7;
    pub use super::RSTE1R::EXTEVNT8;
    pub use super::RSTE1R::EXTEVNT9;
    pub use super::RSTE1R::MSTCMP1;
    pub use super::RSTE1R::MSTCMP2;
    pub use super::RSTE1R::MSTCMP3;
    pub use super::RSTE1R::MSTCMP4;
    pub use super::RSTE1R::MSTPER;
    pub use super::RSTE1R::PER;
    pub use super::RSTE1R::RESYNC;
    pub use super::RSTE1R::SRT;
    pub use super::RSTE1R::TIMEVNT1;
    pub use super::RSTE1R::TIMEVNT2;
    pub use super::RSTE1R::TIMEVNT3;
    pub use super::RSTE1R::TIMEVNT4;
    pub use super::RSTE1R::TIMEVNT5;
    pub use super::RSTE1R::TIMEVNT6;
    pub use super::RSTE1R::TIMEVNT7;
    pub use super::RSTE1R::TIMEVNT8;
    pub use super::RSTE1R::TIMEVNT9;
    pub use super::RSTE1R::UPDATE;
}
...
/// CPT2xCR
pub mod CPT2ECR {
    pub use super::CPT1ECR::EXEV10CPT;
    pub use super::CPT1ECR::EXEV1CPT;
    pub use super::CPT1ECR::EXEV2CPT;
    pub use super::CPT1ECR::EXEV3CPT;
    pub use super::CPT1ECR::EXEV4CPT;
    pub use super::CPT1ECR::EXEV5CPT;
    pub use super::CPT1ECR::EXEV6CPT;
    pub use super::CPT1ECR::EXEV7CPT;
    pub use super::CPT1ECR::EXEV8CPT;
    pub use super::CPT1ECR::EXEV9CPT;
    pub use super::CPT1ECR::SWCPT;
    pub use super::CPT1ECR::TA1RST;
    pub use super::CPT1ECR::TA1SET;
    pub use super::CPT1ECR::TACMP1;
    pub use super::CPT1ECR::TACMP2;
    pub use super::CPT1ECR::TB1RST;
    pub use super::CPT1ECR::TB1SET;
    pub use super::CPT1ECR::TBCMP1;
    pub use super::CPT1ECR::TBCMP2;
    pub use super::CPT1ECR::TC1RST;
    pub use super::CPT1ECR::TC1SET;
    pub use super::CPT1ECR::TCCMP1;
    pub use super::CPT1ECR::TCCMP2;
    pub use super::CPT1ECR::TD1RST;
    pub use super::CPT1ECR::TD1SET;
    pub use super::CPT1ECR::TDCMP1;
    pub use super::CPT1ECR::TDCMP2;
    pub use super::CPT1ECR::TF1RST;
    pub use super::CPT1ECR::TF1SET;
    pub use super::CPT1ECR::TFCMP1;
    pub use super::CPT1ECR::TFCMP2;
    pub use super::CPT1ECR::UDPCPT;
}
...
pub struct RegisterBlock {
    /// Timerx Control Register
    pub TIMECR: RWRegister<u32>,

    /// Timerx Interrupt Status Register
    pub TIMEISR: RORegister<u32>,

    /// Timerx Interrupt Clear Register
    pub TIMEICR: WORegister<u32>,

    /// TIMxDIER
    pub TIMEDIER: RWRegister<u32>,

    /// Timerx Counter Register
    pub CNTER: RWRegister<u32>,

    /// Timerx Period Register
    pub PERER: RWRegister<u32>,

    /// Timerx Repetition Register
    pub REPER: RWRegister<u32>,

    /// Timerx Compare 1 Register
    pub CMP1ER: RWRegister<u32>,

    /// Timerx Compare 1 Compound Register
    pub CMP1CER: RWRegister<u32>,

    /// Timerx Compare 2 Register
    pub CMP2ER: RWRegister<u32>,

    /// Timerx Compare 3 Register
    pub CMP3ER: RWRegister<u32>,

    /// Timerx Compare 4 Register
    pub CMP4ER: RWRegister<u32>,

    /// Timerx Capture 1 Register
    pub CPT1ER: RORegister<u32>,

    /// Timerx Capture 2 Register
    pub CPT2ER: RORegister<u32>,

    /// Timerx Deadtime Register
    pub DTER: RWRegister<u32>,

    /// Timerx Output1 Set Register
    pub SETE1R: RWRegister<u32>,

    /// Timerx Output1 Reset Register
    pub RSTE1R: RWRegister<u32>,

    /// Timerx Output2 Set Register
    pub SETE2R: RWRegister<u32>,

    /// Timerx Output2 Reset Register
    pub RSTE2R: RWRegister<u32>,

    /// Timerx External Event Filtering Register 1
    pub EEFER1: RWRegister<u32>,

    /// Timerx External Event Filtering Register 2
    pub EEFER2: RWRegister<u32>,

    /// TimerA Reset Register
    pub RSTER: RWRegister<u32>,

    /// Timerx Chopper Register
    pub CHPER: RWRegister<u32>,

    /// Timerx Capture 2 Control Register
    pub CPT1ECR: RWRegister<u32>,

    /// CPT2xCR
    pub CPT2ECR: RWRegister<u32>,

    /// Timerx Output Register
    pub OUTER: RWRegister<u32>,

    /// Timerx Fault Register
    pub FLTER: RWRegister<u32>,

    /// HRTIM Timerx Control Register 2
    pub TIMECR2: RWRegister<u32>,

    /// HRTIM Timerx External Event Filtering Register 3
    pub EEEFR3: RWRegister<u32>,
}
