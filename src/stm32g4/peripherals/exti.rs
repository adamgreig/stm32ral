...
pub mod EMR2 {
    ...
    /// Event mask on external/internal line 41
    pub mod EM41 {
        /// Offset (9 bits)
        pub const offset: u32 = 9;
        /// Mask (1 bit: 1 << 9)
    ...
    /// Event mask on external/internal line 42
    pub mod EM42 {
        /// Offset (10 bits)
        pub const offset: u32 = 10;
        /// Mask (1 bit: 1 << 10)
    ...
    /// Event mask on external/internal line 43
    pub mod EM43 {
        /// Offset (11 bits)
        pub const offset: u32 = 11;
        /// Mask (1 bit: 1 << 11)
...
pub mod FTSR2 {
    ...
    pub mod FT33 {
        ...
        /// Write-only values (empty)
        pub mod W {}
        pub use super::FT32::RW;
    }

    /// Falling trigger event configuration of line 40
    pub mod FT40 {
        /// Offset (8 bits)
        pub const offset: u32 = 8;
        /// Mask (1 bit: 1 << 8)
    ...
    /// Falling trigger event configuration of line 41
    pub mod FT41 {
        /// Offset (9 bits)
        pub const offset: u32 = 9;
        /// Mask (1 bit: 1 << 9)
...
pub mod PR2 {
    ...
    pub mod PIF33 {
        ...
        /// Mask (1 bit: 1 << 1)
        pub const mask: u32 = 1 << offset;
        pub use super::PIF32::R;
        pub use super::PIF32::W;
        /// Read-write values (empty)
        pub mod RW {}
    }
