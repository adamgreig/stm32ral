...
pub mod SETF2R {
    pub use super::SETF1R::CMP1;
    pub use super::SETF1R::CMP2;
    pub use super::SETF1R::CMP3;
    pub use super::SETF1R::CMP4;
    pub use super::SETF1R::EXTEVNT1;
    pub use super::SETF1R::EXTEVNT10;
    pub use super::SETF1R::EXTEVNT2;
    pub use super::SETF1R::EXTEVNT3;
    pub use super::SETF1R::EXTEVNT4;
    pub use super::SETF1R::EXTEVNT5;
    pub use super::SETF1R::EXTEVNT6;
    pub use super::SETF1R::EXTEVNT7;
    pub use super::SETF1R::EXTEVNT8;
    pub use super::SETF1R::EXTEVNT9;
    pub use super::SETF1R::MSTCMP1;
    pub use super::SETF1R::MSTCMP2;
    pub use super::SETF1R::MSTCMP3;
    pub use super::SETF1R::MSTCMP4;
    pub use super::SETF1R::MSTPER;
    pub use super::SETF1R::PER;
    pub use super::SETF1R::RESYNC;
    pub use super::SETF1R::SST;
    pub use super::SETF1R::TIMEVNT1;
    pub use super::SETF1R::TIMEVNT2;
    pub use super::SETF1R::TIMEVNT3;
    pub use super::SETF1R::TIMEVNT4;
    pub use super::SETF1R::TIMEVNT5;
    pub use super::SETF1R::TIMEVNT6;
    pub use super::SETF1R::TIMEVNT7;
    pub use super::SETF1R::TIMEVNT8;
    pub use super::SETF1R::TIMEVNT9;
    pub use super::SETF1R::UPDATE;
}
...
/// CPT2xCR
pub mod CPT2FCR {
    pub use super::CPT1FCR::EXEV10CPT;
    pub use super::CPT1FCR::EXEV1CPT;
    pub use super::CPT1FCR::EXEV2CPT;
    pub use super::CPT1FCR::EXEV3CPT;
    pub use super::CPT1FCR::EXEV4CPT;
    pub use super::CPT1FCR::EXEV5CPT;
    pub use super::CPT1FCR::EXEV6CPT;
    pub use super::CPT1FCR::EXEV7CPT;
    pub use super::CPT1FCR::EXEV8CPT;
    pub use super::CPT1FCR::EXEV9CPT;
    pub use super::CPT1FCR::SWCPT;
    pub use super::CPT1FCR::TA1RST;
    pub use super::CPT1FCR::TA1SET;
    pub use super::CPT1FCR::TACMP1;
    pub use super::CPT1FCR::TACMP2;
    pub use super::CPT1FCR::TB1RST;
    pub use super::CPT1FCR::TB1SET;
    pub use super::CPT1FCR::TBCMP1;
    pub use super::CPT1FCR::TBCMP2;
    pub use super::CPT1FCR::TC1RST;
    pub use super::CPT1FCR::TC1SET;
    pub use super::CPT1FCR::TCCMP1;
    pub use super::CPT1FCR::TCCMP2;
    pub use super::CPT1FCR::TD1RST;
    pub use super::CPT1FCR::TD1SET;
    pub use super::CPT1FCR::TDCMP1;
    pub use super::CPT1FCR::TDCMP2;
    pub use super::CPT1FCR::TE1RST;
    pub use super::CPT1FCR::TE1SET;
    pub use super::CPT1FCR::TECMP1;
    pub use super::CPT1FCR::TECMP2;
    pub use super::CPT1FCR::UDPCPT;
}
...
pub struct RegisterBlock {
    ...
    /// Timerx Interrupt Status Register
    pub TIMFISR: RORegister<u32>,

    /// Timerx Interrupt Clear Register
    pub TIMFICR: WORegister<u32>,

    /// TIMxDIER
    pub TIMFDIER: RWRegister<u32>,

    /// Timerx Counter Register
    pub CNTFR: RWRegister<u32>,

    /// Timerx Period Register
    pub PERFR: RWRegister<u32>,

    /// Timerx Repetition Register
    pub REPFR: RWRegister<u32>,

    /// Timerx Compare 1 Register
    pub CMP1FR: RWRegister<u32>,

    /// Timerx Compare 1 Compound Register
    pub CMP1CFR: RWRegister<u32>,

    /// Timerx Compare 2 Register
    pub CMP2FR: RWRegister<u32>,

    /// Timerx Compare 3 Register
    pub CMP3FR: RWRegister<u32>,

    /// Timerx Compare 4 Register
    pub CMP4FR: RWRegister<u32>,

    /// Timerx Capture 1 Register
    pub CPT1FR: RORegister<u32>,

    /// Timerx Capture 2 Register
    pub CPT2FR: RORegister<u32>,

    /// Timerx Deadtime Register
    pub DTFR: RWRegister<u32>,

    /// Timerx Output1 Set Register
    pub SETF1R: RWRegister<u32>,

    /// Timerx Output1 Reset Register
    pub RSTE1R: RWRegister<u32>,

    /// Timerx Output2 Set Register
    pub SETF2R: RWRegister<u32>,

    /// Timerx Output2 Reset Register
    pub RSTF2R: RWRegister<u32>,

    /// Timerx External Event Filtering Register 1
    pub EEFFR1: RWRegister<u32>,

    /// Timerx External Event Filtering Register 2
    pub EEFFR2: RWRegister<u32>,

    /// TimerA Reset Register
    pub RSTFR: RWRegister<u32>,

    /// Timerx Chopper Register
    pub CHPFR: RWRegister<u32>,

    /// Timerx Capture 2 Control Register
    pub CPT1FCR: RWRegister<u32>,

    /// CPT2xCR
    pub CPT2FCR: RWRegister<u32>,

    /// Timerx Output Register
    pub OUTFR: RWRegister<u32>,

    /// Timerx Fault Register
    pub FLTFR: RWRegister<u32>,

    /// HRTIM Timerx Control Register 2
    pub TIMFCR2: RWRegister<u32>,

    /// HRTIM Timerx External Event Filtering Register 3
    pub FEEFR3: RWRegister<u32>,
}
