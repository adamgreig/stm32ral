...
pub mod CPT2DCR {
    ...
    pub use super::CPT1DCR::TF1RST;
    pub use super::CPT1DCR::TF1SET;
    pub use super::CPT1DCR::TFCMP1;
    pub use super::CPT1DCR::TFCMP2;
...
pub struct RegisterBlock {
    ...
    /// HRTIM Timerx Control Register 2
    pub TIMDCR2: RWRegister<u32>,

    /// HRTIM Timerx External Event Filtering Register 3
    pub DEEFR3: RWRegister<u32>,
}
