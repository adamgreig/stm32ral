...
pub use crate::stm32g0::peripherals::fpu_cpacr::Instance;
pub use crate::stm32g0::peripherals::fpu_cpacr::CPACR;
pub use crate::stm32g0::peripherals::fpu_cpacr::{RegisterBlock, ResetValues};
