...
pub use crate::stm32g0::peripherals::wwdg_v2::Instance;
pub use crate::stm32g0::peripherals::wwdg_v2::{RegisterBlock, ResetValues};
pub use crate::stm32g0::peripherals::wwdg_v2::{WWDG_CFR, WWDG_CR, WWDG_SR};
