...
pub use stm32g0::peripherals::mpu::Instance;
pub use stm32g0::peripherals::mpu::{RegisterBlock, ResetValues};
pub use stm32g0::peripherals::mpu::{MPU_CTRL, MPU_RASR, MPU_RBAR, MPU_RNR, MPU_TYPER};
