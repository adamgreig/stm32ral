...
pub use crate::stm32g0::peripherals::tim6_v1::Instance;
pub use crate::stm32g0::peripherals::tim6_v1::{RegisterBlock, ResetValues};
pub use crate::stm32g0::peripherals::tim6_v1::{ARR, CNT, CR1, CR2, DIER, EGR, PSC, SR};
