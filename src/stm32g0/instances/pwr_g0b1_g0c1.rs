...
pub use crate::stm32g0::peripherals::pwr_v3::Instance;
pub use crate::stm32g0::peripherals::pwr_v3::{RegisterBlock, ResetValues};
pub use crate::stm32g0::peripherals::pwr_v3::{
    CR1, CR2, CR3, CR4, PDCRA, PDCRB, PDCRC, PDCRD, PDCRE, PDCRF, PUCRA, PUCRB, PUCRC, PUCRD,
    PUCRE, PUCRF, SCR, SR1, SR2,
};
