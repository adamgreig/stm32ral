...
pub use crate::stm32g0::peripherals::dmamux_v1::Instance;
pub use crate::stm32g0::peripherals::dmamux_v1::{RegisterBlock, ResetValues};
pub use crate::stm32g0::peripherals::dmamux_v1::{
    C0CR, C1CR, C2CR, C3CR, C4CR, C5CR, C6CR, RG0CR, RG1CR, RG2CR, RG3CR, RGCFR, RGSR,
};
