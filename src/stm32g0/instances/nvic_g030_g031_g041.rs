...
pub use crate::stm32g0::peripherals::nvic_v1::{RegisterBlock, ResetValues};
pub use crate::stm32g0::peripherals::nvic_v1::{
    ICER, ICPR, IPR0, IPR1, IPR2, IPR3, IPR4, IPR5, IPR6, IPR7, IPR8, ISER, ISPR,
};
