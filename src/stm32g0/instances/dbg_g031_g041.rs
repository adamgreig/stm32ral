...
pub use crate::stm32g0::peripherals::dbg_v1::Instance;
pub use crate::stm32g0::peripherals::dbg_v1::{RegisterBlock, ResetValues};
pub use crate::stm32g0::peripherals::dbg_v1::{APB_FZ1, APB_FZ2, CR, IDCODE};
