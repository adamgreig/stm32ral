...
pub use crate::stm32g0::peripherals::fpu::Instance;
pub use crate::stm32g0::peripherals::fpu::{RegisterBlock, ResetValues};
pub use crate::stm32g0::peripherals::fpu::{FPCAR, FPCCR, FPSCR};
