...
pub use crate::stm32g0::peripherals::syscfg::Instance;
pub use crate::stm32g0::peripherals::syscfg::{RegisterBlock, ResetValues};
pub use crate::stm32g0::peripherals::syscfg::{CFGR1, CFGR2};
