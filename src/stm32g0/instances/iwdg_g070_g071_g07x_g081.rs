...
pub use crate::stm32g0::peripherals::iwdg_v3::Instance;
pub use crate::stm32g0::peripherals::iwdg_v3::{RegisterBlock, ResetValues};
pub use crate::stm32g0::peripherals::iwdg_v3::{HWCFGR, IPIDR, KR, PR, RLR, SIDR, SR, VERR, WINR};
