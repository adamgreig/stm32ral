...
pub use crate::stm32g0::peripherals::iwdg_v1::Instance;
pub use crate::stm32g0::peripherals::iwdg_v1::{RegisterBlock, ResetValues};
pub use crate::stm32g0::peripherals::iwdg_v1::{KR, PR, RLR, SR, WINR};
