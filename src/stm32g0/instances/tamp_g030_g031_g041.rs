...
pub use crate::stm32g0::peripherals::tamp_v1::Instance;
pub use crate::stm32g0::peripherals::tamp_v1::{RegisterBlock, ResetValues};
pub use crate::stm32g0::peripherals::tamp_v1::{
    BKP0R, BKP1R, BKP2R, BKP3R, BKP4R, CR1, CR2, FLTCR, IER, MISR, SCR, SR,
};
