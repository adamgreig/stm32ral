...
pub use crate::stm32g0::peripherals::lptim::Instance;
pub use crate::stm32g0::peripherals::lptim::{RegisterBlock, ResetValues};
pub use crate::stm32g0::peripherals::lptim::{ARR, CFGR, CFGR2, CMP, CNT, CR, ICR, IER, ISR};
