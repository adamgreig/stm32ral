...
pub use stm32g0::peripherals::lptim::Instance;
pub use stm32g0::peripherals::lptim::{RegisterBlock, ResetValues};
pub use stm32g0::peripherals::lptim::{ARR, CFGR, CFGR2, CMP, CNT, CR, ICR, IER, ISR};
