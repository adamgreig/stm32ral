...
pub use crate::stm32g0::peripherals::vrefbuf_v1::Instance;
pub use crate::stm32g0::peripherals::vrefbuf_v1::{RegisterBlock, ResetValues};
pub use crate::stm32g0::peripherals::vrefbuf_v1::{CCR, CSR};
