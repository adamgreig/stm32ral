...
pub use crate::stm32g0::peripherals::scb_actrl::Instance;
pub use crate::stm32g0::peripherals::scb_actrl::ACTRL;
pub use crate::stm32g0::peripherals::scb_actrl::{RegisterBlock, ResetValues};
