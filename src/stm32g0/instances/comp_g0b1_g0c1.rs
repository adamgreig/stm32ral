...
pub use crate::stm32g0::peripherals::comp_v2::Instance;
pub use crate::stm32g0::peripherals::comp_v2::{RegisterBlock, ResetValues};
pub use crate::stm32g0::peripherals::comp_v2::{COMP1_CSR, COMP2_CSR, COMP3_CSR};
