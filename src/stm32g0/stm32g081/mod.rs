...
pub use super::instances::adc_g07x_g081 as adc;
pub use super::instances::aes_g07x_g081 as aes;
pub use super::instances::comp;
pub use super::instances::crc;
pub use super::instances::dac;
pub use super::instances::dbg_g07x_g081 as dbg;
pub use super::instances::dma_g07x_g081 as dma;
pub use super::instances::dmamux_g07x_g081 as dmamux;
pub use super::instances::exti_g07x_g081 as exti;
pub use super::instances::flash;
pub use super::instances::gpio;
pub use super::instances::hdmi_cec;
pub use super::instances::i2c;
pub use super::instances::iwdg_g07x_g081 as iwdg;
pub use super::instances::lptim;
pub use super::instances::lpuart_g07x_g081 as lpuart;
pub use super::instances::mpu;
pub use super::instances::nvic_g07x_g081 as nvic;
pub use super::instances::pwr_g07x_g081 as pwr;
pub use super::instances::rcc_g07x_g081 as rcc;
pub use super::instances::rng;
pub use super::instances::rtc_g07x_g081 as rtc;
pub use super::instances::scb;
pub use super::instances::spi_g07x_g081 as spi;
pub use super::instances::stk;
pub use super::instances::syscfg_vrefbuf;
pub use super::instances::tamp_g07x_g081 as tamp;
pub use super::instances::tim14;
pub use super::instances::tim15;
pub use super::instances::tim16;
pub use super::instances::tim17;
pub use super::instances::tim1_g07x_g081 as tim1;
pub use super::instances::tim2;
pub use super::instances::tim3;
pub use super::instances::tim6;
pub use super::instances::tim7;
pub use super::instances::ucpd;
pub use super::instances::usart_g07x_g081 as usart;
