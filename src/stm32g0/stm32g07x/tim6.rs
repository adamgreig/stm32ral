...
pub use crate::stm32g0::peripherals::tim6_v3::Instance;
pub use crate::stm32g0::peripherals::tim6_v3::{RegisterBlock, ResetValues};
pub use crate::stm32g0::peripherals::tim6_v3::{ARR, CNT, CR1, CR2, DIER, EGR, PSC, SR};
