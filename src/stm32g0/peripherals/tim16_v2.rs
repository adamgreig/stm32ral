...
pub mod CR2 {
    ...
    pub mod CCPC {
        ...
        pub mod RW {
            ...
            /// 0b1: CCxE, CCxNE and OCxM bits are preloaded, after having been written, they are updated only when COM bit is set.
            pub const B_0x1: u32 = 0b1;
        }
    }
...
pub mod BDTR {
    ...
    pub mod MOE {
        ...
        pub mod RW {
            ...
            /// 0b1: OC and OCN outputs are enabled if their respective enable bits are set (CCxE, CCxNE in TIMx_CCER register)See OC/OCN enable description for more details (
            pub const B_0x1: u32 = 0b1;
        }
    }
