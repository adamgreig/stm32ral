...
pub mod CR1 {
    ...
    pub mod URS {
        ...
        pub mod RW {
            ...
            /// 0b0: Any of the following events generate an update interrupt or DMA request if enabled. These events can be:
            pub const B_0x0: u32 = 0b0;
...
pub mod CR2 {
    ...
    pub mod TI1S {
        ...
        pub mod RW {
            ...
            /// 0b1: The TIMx_CH1, CH2 and CH3 pins are connected to the TI1 input (XOR combination)
            pub const B_0x1: u32 = 0b1;
        }
    }
...
pub mod SMCR {
    ...
    pub mod OCCS {
        ...
        pub mod RW {
            ...
            /// 0b0: OCREF_CLR_INT is connected to COMP1 or COMP2 output depending on TIM1_OR1.OCREF_CLR
            pub const B_0x0: u32 = 0b0;

            /// 0b1: OCREF_CLR_INT is connected to ETRF
            pub const B_0x1: u32 = 0b1;
        }
    }
...
pub mod DIER {
    ...
    pub mod CC3IE {
        ...
        pub mod RW {
            ...
            /// 0b0: CC3 interrupt disabled
            pub const B_0x0: u32 = 0b0;

            /// 0b1: CC3 interrupt enabled
            pub const B_0x1: u32 = 0b1;
        }
    }
    ...
    pub mod CC4IE {
        ...
        pub mod RW {
            ...
            /// 0b0: CC4 interrupt disabled
            pub const B_0x0: u32 = 0b0;

            /// 0b1: CC4 interrupt enabled
            pub const B_0x1: u32 = 0b1;
        }
    }
    ...
    pub mod CC3DE {
        ...
        pub mod RW {
            ...
            /// 0b0: CC3 DMA request disabled
            pub const B_0x0: u32 = 0b0;

            /// 0b1: CC3 DMA request enabled
            pub const B_0x1: u32 = 0b1;
        }
    }
    ...
    pub mod CC4DE {
        ...
        pub mod RW {
            ...
            /// 0b0: CC4 DMA request disabled
            pub const B_0x0: u32 = 0b0;

            /// 0b1: CC4 DMA request enabled
            pub const B_0x1: u32 = 0b1;
        }
    }
...
pub mod CCMR1 {
    ...
    pub mod OC1CE {
        ...
        pub mod RW {
            ...
            /// 0b0: OC1Ref is not affected by the ocref_clr_int signal
            pub const B_0x0: u32 = 0b0;

            /// 0b1: OC1Ref is cleared as soon as a High level is detected on ocref_clr_int signal (OCREF_CLR input or ETRF input)
            pub const B_0x1: u32 = 0b1;
        }
    }
...
pub mod CCMR2 {
    ...
    pub mod CC3S {
        ...
        pub mod RW {
            ...
            /// 0b01: CC3 channel is configured as input, IC3 is mapped on TI3
            pub const B_0x1: u32 = 0b01;

            /// 0b10: CC3 channel is configured as input, IC3 is mapped on TI4
            pub const B_0x2: u32 = 0b10;

            /// 0b11: CC3 channel is configured as input, IC3 is mapped on TRC. This mode is working only if an internal trigger input is selected through TS bit (TIMx_SMCR register)
            pub const B_0x3: u32 = 0b11;
        }
    }
    ...
    pub mod CC4S {
        ...
        pub mod RW {
            ...
            /// 0b01: CC4 channel is configured as input, IC4 is mapped on TI4
            pub const B_0x1: u32 = 0b01;

            /// 0b10: CC4 channel is configured as input, IC4 is mapped on TI3
            pub const B_0x2: u32 = 0b10;

            /// 0b11: CC4 channel is configured as input, IC4 is mapped on TRC. This mode is working only if an internal trigger input is selected through TS bit (TIMx_SMCR register)
            pub const B_0x3: u32 = 0b11;
        }
    }
...
pub mod BDTR {
    ...
    pub mod LOCK {
        ...
        pub mod RW {
            ...
            /// 0b01: LOCK Level 1 = DTG bits in TIMx_BDTR register, OISx and OISxN bits in TIMx_CR2 register and BK2BID, BKBID, BK2DSRM, BKDSRM, BK2P, BK2E, BK2F\[3:0\], BKF\[3:0\], AOE, BKP, BKE, OSSI, OSSR and DTG\[7:0\] bits in TIMx_BDTR register can no longer be written.
            pub const B_0x1: u32 = 0b01;
    ...
    pub mod OSSI {
        ...
        pub mod RW {
            ...
            /// 0b0: When inactive, OC/OCN outputs are disabled (the timer releases the output control which is taken over by the GPIO logic and which imposes a Hi-Z state).
            pub const B_0x0: u32 = 0b0;

            /// 0b1: When inactive, OC/OCN outputs are first forced with their inactive level then forced to their idle level after the deadtime. The timer maintains its control over the output.
            pub const B_0x1: u32 = 0b1;
        }
    }
    ...
    pub mod OSSR {
        ...
        pub mod RW {
            ...
            /// 0b0: When inactive, OC/OCN outputs are disabled (the timer releases the output control which is taken over by the GPIO logic, which forces a Hi-Z state).
            pub const B_0x0: u32 = 0b0;
    ...
    pub mod MOE {
        ...
        pub mod RW {
            ...
            /// 0b0: In response to a break 2 event. OC and OCN outputs are disabled
            pub const B_0x0: u32 = 0b0;
    ...
    pub mod BK2F {
        ...
        pub mod RW {
            ...
            /// 0b0000: No filter, BRK2 acts asynchronously
            pub const B_0x0: u32 = 0b0000;
    ...
    pub mod BK2E {
        ...
        pub mod RW {
            ...
            /// 0b0: Break input BRK2 disabled
            pub const B_0x0: u32 = 0b0;

            /// 0b1: Break input BRK2 enabled
            pub const B_0x1: u32 = 0b1;
        }
    }
...
pub mod OR1 {
    ...
    pub mod OCREF_CLR {
        ...
        pub mod RW {
            ...
            /// 0b0: COMP1 output is connected to the OCREF_CLR input
            pub const B_0x0: u32 = 0b0;

            /// 0b1: COMP2 output is connected to the OCREF_CLR input
            pub const B_0x1: u32 = 0b1;
        }
    }
}
...
pub mod CCR5 {
    ...
    pub mod GC5C1 {
        ...
        pub mod RW {
            ...
            /// 0b0: No effect of OC5REF on OC1REFC5
            pub const B_0x0: u32 = 0b0;
...
pub mod AF1 {
    ...
    pub mod BKINP {
        ...
        pub mod RW {
            ...
            /// 0b0: BKIN input polarity is not inverted (active low if BKP=0, active high if BKP=1)
            pub const B_0x0: u32 = 0b0;

            /// 0b1: BKIN input polarity is inverted (active high if BKP=0, active low if BKP=1)
            pub const B_0x1: u32 = 0b1;
        }
    }
    ...
    pub mod BKCMP1P {
        ...
        pub mod RW {
            ...
            /// 0b0: COMP1 input polarity is not inverted (active low if BKP=0, active high if BKP=1)
            pub const B_0x0: u32 = 0b0;

            /// 0b1: COMP1 input polarity is inverted (active high if BKP=0, active low if BKP=1)
            pub const B_0x1: u32 = 0b1;
        }
    }
    ...
    pub mod BKCMP2P {
        ...
        pub mod RW {
            ...
            /// 0b0: COMP2 input polarity is not inverted (active low if BKP=0, active high if BKP=1)
            pub const B_0x0: u32 = 0b0;

            /// 0b1: COMP2 input polarity is inverted (active high if BKP=0, active low if BKP=1)
            pub const B_0x1: u32 = 0b1;
        }
    }
...
pub mod AF2 {
    ...
    pub mod BK2INE {
        ...
        pub mod RW {
            ...
            /// 0b0: BKIN2 input disabled
            pub const B_0x0: u32 = 0b0;

            /// 0b1: BKIN2 input enabled
            pub const B_0x1: u32 = 0b1;
        }
    }
    ...
    pub mod BK2INP {
        ...
        pub mod RW {
            ...
            /// 0b0: BKIN2 input polarity is not inverted (active low if BK2P=0, active high if BK2P=1)
            pub const B_0x0: u32 = 0b0;

            /// 0b1: BKIN2 input polarity is inverted (active high if BK2P=0, active low if BK2P=1)
            pub const B_0x1: u32 = 0b1;
        }
    }
    ...
    pub mod BK2CMP1P {
        ...
        pub mod RW {
            ...
            /// 0b0: COMP1 input polarity is not inverted (active low if BK2P=0, active high if BK2P=1)
            pub const B_0x0: u32 = 0b0;

            /// 0b1: COMP1 input polarity is inverted (active high if BK2P=0, active low if BK2P=1)
            pub const B_0x1: u32 = 0b1;
        }
    }
    ...
    pub mod BK2CMP2P {
        ...
        pub mod RW {
            ...
            /// 0b0: COMP2 input polarity is not inverted (active low if BK2P=0, active high if BK2P=1)
            pub const B_0x0: u32 = 0b0;

            /// 0b1: COMP2 input polarity is inverted (active high if BK2P=0, active low if BK2P=1)
            pub const B_0x1: u32 = 0b1;
        }
    }
}
