...
pub mod CR2 {
    ...
    pub mod TI1S {
        ...
        pub mod RW {
            ...
            /// 0b1: The TIMx_CH1, CH2 and CH3 pins are connected to the TI1 input (XOR combination) See also
            pub const B_0x1: u32 = 0b1;
        }
    }
}
...
pub mod SMCR {
    ...
    pub mod OCCS {
        ...
        pub mod RW {
            ...
            /// 0b0: OCREF_CLR_INT is connected to COMP1 or COMP2 output depending on TIMx_OR1.OCREF_CLR
            pub const B_0x0: u32 = 0b0;
...
pub mod CCMR1 {
    ...
    pub mod CC2S {
        ...
        pub mod RW {
            ...
            /// 0b11: CC2 channel is configured as input, IC2 is mapped on TRC. This mode is working only if an internal trigger input is selected through TS bit (TIMx_SMCR register)
            pub const B_0x3: u32 = 0b11;
        }
    }
    ...
    pub mod OC1CE {
        ...
        pub mod RW {
            ...
            /// 0b0: OC1Ref is not affected by the ETRF input
            pub const B_0x0: u32 = 0b0;

            /// 0b1: OC1Ref is cleared as soon as a High level is detected on ETRF input
            pub const B_0x1: u32 = 0b1;
        }
    }
