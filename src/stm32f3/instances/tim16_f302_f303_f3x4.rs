...
pub use crate::stm32f3::peripherals::tim16_v2::Instance;
pub use crate::stm32f3::peripherals::tim16_v2::{RegisterBlock, ResetValues};
pub use crate::stm32f3::peripherals::tim16_v2::{
    ARR, BDTR, CCER, CCMR1, CCR1, CNT, CR1, CR2, DCR, DIER, DMAR, EGR, OR, PSC, RCR, SR,
};
