...
pub use crate::stm32f3::peripherals::pwr::Instance;
pub use crate::stm32f3::peripherals::pwr::{RegisterBlock, ResetValues};
pub use crate::stm32f3::peripherals::pwr::{CR, CSR};
