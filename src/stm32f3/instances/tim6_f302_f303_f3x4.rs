...
pub use stm32f3::peripherals::tim6_v2::Instance;
pub use stm32f3::peripherals::tim6_v2::{RegisterBlock, ResetValues};
pub use stm32f3::peripherals::tim6_v2::{ARR, CNT, CR1, CR2, DIER, EGR, PSC, SR};
