...
//!
//! Used by: stm32f301, stm32f373, stm32f3x4

#[cfg(not(feature = "nosync"))]
pub use stm32f3::peripherals::usart::Instance;
pub use stm32f3::peripherals::usart::{RegisterBlock, ResetValues};
pub use stm32f3::peripherals::usart::{BRR, CR1, CR2, CR3, GTPR, ICR, ISR, RDR, RQR, RTOR, TDR};
