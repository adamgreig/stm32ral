...
pub use crate::stm32f3::peripherals::opamp_v1::Instance;
pub use crate::stm32f3::peripherals::opamp_v1::OPAMP2_CSR;
pub use crate::stm32f3::peripherals::opamp_v1::{RegisterBlock, ResetValues};
