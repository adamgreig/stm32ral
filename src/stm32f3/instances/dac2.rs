...
pub use crate::stm32f3::peripherals::dac2::Instance;
pub use crate::stm32f3::peripherals::dac2::{RegisterBlock, ResetValues};
pub use crate::stm32f3::peripherals::dac2::{CR, DHR12L1, DHR12R1, DHR8R1, DOR1, SR, SWTRIGR};
