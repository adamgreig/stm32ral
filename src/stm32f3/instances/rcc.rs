...
pub use stm32f3::peripherals::rcc::Instance;
pub use stm32f3::peripherals::rcc::{RegisterBlock, ResetValues};
pub use stm32f3::peripherals::rcc::{
    AHBENR, AHBRSTR, APB1ENR, APB1RSTR, APB2ENR, APB2RSTR, BDCR, CFGR, CFGR2, CFGR3, CIR, CR, CSR,
};
