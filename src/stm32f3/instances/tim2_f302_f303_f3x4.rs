...
pub use crate::stm32f3::peripherals::tim2_v1::Instance;
pub use crate::stm32f3::peripherals::tim2_v1::{RegisterBlock, ResetValues};
pub use crate::stm32f3::peripherals::tim2_v1::{
