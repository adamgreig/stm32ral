...
pub use crate::stm32f3::peripherals::exti_v1::Instance;
pub use crate::stm32f3::peripherals::exti_v1::{RegisterBlock, ResetValues};
pub use crate::stm32f3::peripherals::exti_v1::{EMR, FTSR, IMR, PR, RTSR, SWIER};
