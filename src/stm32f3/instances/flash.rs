...
pub use crate::stm32f3::peripherals::flash::Instance;
pub use crate::stm32f3::peripherals::flash::{RegisterBlock, ResetValues};
pub use crate::stm32f3::peripherals::flash::{ACR, AR, CR, KEYR, OBR, OPTKEYR, SR, WRPR};
