...
pub use stm32f3::peripherals::cec::Instance;
pub use stm32f3::peripherals::cec::{RegisterBlock, ResetValues};
pub use stm32f3::peripherals::cec::{CFGR, CR, IER, ISR, RXDR, TXDR};
