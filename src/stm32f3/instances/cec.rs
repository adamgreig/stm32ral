...
pub use crate::stm32f3::peripherals::cec::Instance;
pub use crate::stm32f3::peripherals::cec::{RegisterBlock, ResetValues};
pub use crate::stm32f3::peripherals::cec::{CFGR, CR, IER, ISR, RXDR, TXDR};
