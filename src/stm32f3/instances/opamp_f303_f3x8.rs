...
pub use stm32f3::peripherals::opamp_v2::Instance;
pub use stm32f3::peripherals::opamp_v2::{RegisterBlock, ResetValues};
pub use stm32f3::peripherals::opamp_v2::{OPAMP1_CSR, OPAMP2_CSR, OPAMP3_CSR, OPAMP4_CSR};
