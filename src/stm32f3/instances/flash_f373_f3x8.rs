...
pub use crate::stm32f3::peripherals::flash_v2::Instance;
pub use crate::stm32f3::peripherals::flash_v2::{RegisterBlock, ResetValues};
pub use crate::stm32f3::peripherals::flash_v2::{ACR, AR, CR, KEYR, OBR, OPTKEYR, SR, WRPR};
