...
pub use crate::stm32f3::peripherals::mpu::Instance;
pub use crate::stm32f3::peripherals::mpu::{RegisterBlock, ResetValues};
pub use crate::stm32f3::peripherals::mpu::{MPU_CTRL, MPU_RASR, MPU_RBAR, MPU_RNR, MPU_TYPER};
