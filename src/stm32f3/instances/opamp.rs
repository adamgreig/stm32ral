...
pub use crate::stm32f3::peripherals::opamp::Instance;
pub use crate::stm32f3::peripherals::opamp::OPAMP2_CSR;
pub use crate::stm32f3::peripherals::opamp::{RegisterBlock, ResetValues};
