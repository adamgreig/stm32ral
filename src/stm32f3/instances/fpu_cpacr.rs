...
pub use stm32f3::peripherals::fpu_cpacr::Instance;
pub use stm32f3::peripherals::fpu_cpacr::CPACR;
pub use stm32f3::peripherals::fpu_cpacr::{RegisterBlock, ResetValues};
