...
pub use crate::stm32f3::peripherals::tim2_v2::Instance;
pub use crate::stm32f3::peripherals::tim2_v2::{RegisterBlock, ResetValues};
pub use crate::stm32f3::peripherals::tim2_v2::{
