...
pub use stm32f3::peripherals::spi_v2::Instance;
pub use stm32f3::peripherals::spi_v2::{RegisterBlock, ResetValues};
pub use stm32f3::peripherals::spi_v2::{CR1, CR2, CRCPR, DR, I2SCFGR, I2SPR, RXCRCR, SR, TXCRCR};
