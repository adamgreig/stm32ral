...
pub struct RegisterBlock {
    /// configuration register 1
    pub SYSCFG_CFGR1: RWRegister<u32>,

    /// CCM SRAM protection register
    pub SYSCFG_RCR: RWRegister<u32>,

    /// external interrupt configuration register 1
    pub SYSCFG_EXTICR1: RWRegister<u32>,

    /// external interrupt configuration register 2
    pub SYSCFG_EXTICR2: RWRegister<u32>,

    /// external interrupt configuration register 3
    pub SYSCFG_EXTICR3: RWRegister<u32>,

    /// external interrupt configuration register 4
    pub SYSCFG_EXTICR4: RWRegister<u32>,

    /// configuration register 2
    pub SYSCFG_CFGR2: RWRegister<u32>,
...
pub struct ResetValues {
    pub SYSCFG_CFGR1: u32,
    pub SYSCFG_RCR: u32,
    pub SYSCFG_EXTICR1: u32,
    pub SYSCFG_EXTICR2: u32,
    pub SYSCFG_EXTICR3: u32,
    pub SYSCFG_EXTICR4: u32,
    pub SYSCFG_CFGR2: u32,
    pub COMP1_CSR: u32,
    pub COMP2_CSR: u32,
    pub COMP3_CSR: u32,
    pub COMP4_CSR: u32,
