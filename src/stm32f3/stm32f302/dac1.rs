...
pub use crate::stm32f3::peripherals::dac1_v1::Instance;
pub use crate::stm32f3::peripherals::dac1_v1::{RegisterBlock, ResetValues};
pub use crate::stm32f3::peripherals::dac1_v1::{
