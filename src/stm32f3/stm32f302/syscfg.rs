...
pub mod CFGR1 {
    ...
    pub mod MEM_MODE {
        ...
        pub mod RW {
            ...
            /// 0b100: FMC Bank (Only the first two banks) (Available on STM32F302xD/E only)
    ...
    pub mod ENCODER_MODE {
        ...
        pub mod RW {
            ...
            /// 0b11: TIM4 IC1 and TIM4 IC2 are connected to TIM15 IC1 and TIM15 IC2 respectively (STM32F302xB/C devices only)
...
pub mod CFGR2 {
    ...
    pub mod LOCKUP_LOCK {
        ...
        pub mod RW {
            ...
            /// 0b0: Cortex-M4 LOCKUP output disconnected from TIM1/15/16/17 Break input
            pub const Disconnected: u32 = 0b0;

            /// 0b1: Cortex-M4 LOCKUP output connected to TIM1/15/16/17 Break input
