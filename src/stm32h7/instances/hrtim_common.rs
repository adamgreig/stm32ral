...
pub use crate::stm32h7::peripherals::hrtim_common::Instance;
pub use crate::stm32h7::peripherals::hrtim_common::{
...
pub use crate::stm32h7::peripherals::hrtim_common::{RegisterBlock, ResetValues};
