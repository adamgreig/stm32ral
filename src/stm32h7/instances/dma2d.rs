...
pub use crate::stm32h7::peripherals::dma2d::Instance;
pub use crate::stm32h7::peripherals::dma2d::{RegisterBlock, ResetValues};
pub use crate::stm32h7::peripherals::dma2d::{
    AMTCR, BGCMAR, BGCOLR, BGMAR, BGOR, BGPFCCR, CR, FGCMAR, FGCOLR, FGMAR, FGOR, FGPFCCR, IFCR,
    ISR, LWR, NLR, OCOLR, OMAR, OOR, OPFCCR,
};
...
pub const DMA2D: *const RegisterBlock = 0x52001000 as *const _;
