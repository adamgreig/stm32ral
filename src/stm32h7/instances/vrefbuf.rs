...
pub use crate::stm32h7::peripherals::vrefbuf::Instance;
pub use crate::stm32h7::peripherals::vrefbuf::{RegisterBlock, ResetValues};
pub use crate::stm32h7::peripherals::vrefbuf::{CCR, CSR};
