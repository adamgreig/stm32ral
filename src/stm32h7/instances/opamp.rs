...
pub use crate::stm32h7::peripherals::opamp::Instance;
pub use crate::stm32h7::peripherals::opamp::{RegisterBlock, ResetValues};
pub use crate::stm32h7::peripherals::opamp::{
    OPAMP1_CSR, OPAMP1_HSOTR, OPAMP1_OTR, OPAMP2_CSR, OPAMP2_HSOTR, OPAMP2_OTR,
};
...
pub const OPAMP: *const RegisterBlock = 0x40009000 as *const _;
