...
pub use crate::stm32h7::peripherals::lptim::Instance;
pub use crate::stm32h7::peripherals::lptim::{RegisterBlock, ResetValues};
pub use crate::stm32h7::peripherals::lptim::{ARR, CFGR, CFGR2, CMP, CNT, CR, ICR, IER, ISR};
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const LPTIM2: *const RegisterBlock = 0x58002400 as *const _;
