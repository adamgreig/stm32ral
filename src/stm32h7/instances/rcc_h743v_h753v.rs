...
pub use crate::stm32h7::peripherals::rcc_v2::Instance;
pub use crate::stm32h7::peripherals::rcc_v2::{RegisterBlock, ResetValues};
pub use crate::stm32h7::peripherals::rcc_v2::{
    ...
    CSICFGR, CSR, D1CCIPR, D1CFGR, D2CCIP1R, D2CCIP2R, D2CFGR, D3AMR, D3CCIPR, D3CFGR, GCR, ICSCR,
    PLL1DIVR, PLL1FRACR, PLL2DIVR, PLL2FRACR, PLL3DIVR, PLL3FRACR, PLLCFGR, PLLCKSELR, RSR,
};
