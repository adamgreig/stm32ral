...
pub use crate::stm32h7::peripherals::tim17::Instance;
pub use crate::stm32h7::peripherals::tim17::{RegisterBlock, ResetValues};
pub use crate::stm32h7::peripherals::tim17::{
    ARR, BDTR, CCER, CCMR1, CCR1, CNT, CR1, CR2, DCR, DIER, DMAR, EGR, PSC, RCR, SR, TIM17_AF1,
    TIM17_TISEL,
};
