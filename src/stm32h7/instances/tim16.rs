...
pub use crate::stm32h7::peripherals::tim16::Instance;
pub use crate::stm32h7::peripherals::tim16::{RegisterBlock, ResetValues};
pub use crate::stm32h7::peripherals::tim16::{
    ARR, BDTR, CCER, CCMR1, CCR1, CNT, CR1, CR2, DCR, DIER, DMAR, EGR, PSC, RCR, SR, TIM16_AF1,
    TIM16_TISEL,
};
