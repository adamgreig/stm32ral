...
pub use crate::stm32h7::peripherals::scb_actrl::Instance;
pub use crate::stm32h7::peripherals::scb_actrl::ACTRL;
pub use crate::stm32h7::peripherals::scb_actrl::{RegisterBlock, ResetValues};
