...
pub use crate::stm32h7::peripherals::flash_v2::{
    ACR, ACR_, BOOT4_CURR, BOOT4_CURR_, BOOT4_PRGR, BOOT4_PRGR_, BOOT7_CURR, BOOT7_CURR_,
    BOOT7_PRGR, BOOT7_PRGR_, CCR1, CCR2, CR1, CR2, CRCCR1, CRCCR2, CRCDATAR, CRCEADDR1, CRCEADDR2,
    CRCSADDR1, CRCSADDR2, FAR1, FAR2, KEYR1, KEYR2, OPTCCR, OPTCCR_, OPTCR, OPTCR_, OPTKEYR,
    OPTKEYR_, OPTSR_CUR, OPTSR_CUR_, OPTSR_PRG, OPTSR_PRG_, PRAR_CUR1, PRAR_CUR2, PRAR_PRG1,
    PRAR_PRG2, SCAR_CUR1, SCAR_CUR2, SCAR_PRG1, SCAR_PRG2, SR1, SR2, WPSN_CURR1, WPSN_CURR2,
    WPSN_PRGR1, WPSN_PRGR2,
};
...
pub mod FLASH {
    ...
    pub const reset: ResetValues = ResetValues {
        ...
        OPTCCR_: 0x00000000,
        BOOT7_CURR_: 0x00000000,
        BOOT7_PRGR_: 0x00000000,
        BOOT4_CURR_: 0x00000000,
        BOOT4_PRGR_: 0x00000000,
        KEYR1: 0x00000000,
        CR1: 0x00000031,
        SR1: 0x00000000,
        CCR1: 0x00000000,
