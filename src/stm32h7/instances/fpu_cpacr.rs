...
pub use crate::stm32h7::peripherals::fpu_cpacr::Instance;
pub use crate::stm32h7::peripherals::fpu_cpacr::CPACR;
pub use crate::stm32h7::peripherals::fpu_cpacr::{RegisterBlock, ResetValues};
