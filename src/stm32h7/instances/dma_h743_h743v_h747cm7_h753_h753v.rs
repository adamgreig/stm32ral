...
pub use crate::stm32h7::peripherals::dma_v1::Instance;
pub use crate::stm32h7::peripherals::dma_v1::{RegisterBlock, ResetValues};
pub use crate::stm32h7::peripherals::dma_v1::{
