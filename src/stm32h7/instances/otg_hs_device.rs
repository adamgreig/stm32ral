...
pub use crate::stm32h7::peripherals::otg_hs_device::{
    DAINT, DAINTMSK, DCFG, DCTL, DEACHINT, DEACHINTMSK, DIEP, DIEPCTL0, DIEPCTL1, DIEPCTL2,
    DIEPCTL3, DIEPCTL4, DIEPCTL6, DIEPCTL7, DIEPDMA1, DIEPDMA2, DIEPDMA3, DIEPDMA4, DIEPDMA5,
    DIEPEMPMSK, DIEPINT0, DIEPINT1, DIEPINT2, DIEPINT3, DIEPINT4, DIEPINT5, DIEPINT6, DIEPINT7,
    DIEPMSK, DIEPTSIZ0, DIEPTSIZ1, DIEPTSIZ2, DIEPTSIZ3, DIEPTSIZ4, DIEPTSIZ5, DOEPCTL0, DOEPCTL1,
    DOEPCTL2, DOEPCTL3, DOEPCTL4, DOEPCTL5, DOEPCTL6, DOEPCTL7, DOEPINT0, DOEPINT1, DOEPINT2,
    DOEPINT3, DOEPINT4, DOEPINT5, DOEPINT6, DOEPINT7, DOEPMSK, DOEPTSIZ0, DOEPTSIZ1, DOEPTSIZ2,
    DOEPTSIZ3, DOEPTSIZ4, DOEPTSIZ5, DOEPTSIZ6, DOEPTSIZ7, DSTS, DTHRCTL, DTXFSTS0, DTXFSTS1,
    DTXFSTS2, DTXFSTS3, DTXFSTS4, DTXFSTS5, DTXFSTS6, DTXFSTS7, DVBUSDIS, DVBUSPULSE,
};
