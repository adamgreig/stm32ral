...
pub use crate::stm32h7::peripherals::spi_v1::Instance;
pub use crate::stm32h7::peripherals::spi_v1::{RegisterBlock, ResetValues};
pub use crate::stm32h7::peripherals::spi_v1::{
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const SPI6: *const RegisterBlock = 0x58001400 as *const _;
