...
pub use crate::stm32h7::peripherals::tim3_v1::Instance;
pub use crate::stm32h7::peripherals::tim3_v1::{RegisterBlock, ResetValues};
pub use crate::stm32h7::peripherals::tim3_v1::{
