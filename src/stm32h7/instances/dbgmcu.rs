...
pub use crate::stm32h7::peripherals::dbgmcu::Instance;
pub use crate::stm32h7::peripherals::dbgmcu::{RegisterBlock, ResetValues};
pub use crate::stm32h7::peripherals::dbgmcu::{APB1LFZ1, APB2FZ1, APB3FZ1, APB4FZ1, CR, IDC};
