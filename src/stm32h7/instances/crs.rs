...
pub use crate::stm32h7::peripherals::crs::Instance;
pub use crate::stm32h7::peripherals::crs::{RegisterBlock, ResetValues};
pub use crate::stm32h7::peripherals::crs::{CFGR, CR, ICR, ISR};
...
pub const CRS: *const RegisterBlock = 0x40008400 as *const _;
