...
pub use crate::stm32h7::peripherals::sdmmc_v2::{
    ACKTIMER, ARGR, CLKCR, CMDR, DCNTR, DCTRL, DLENR, DTIMER, FIFOR, ICR, IDMABASE0R, IDMABASE1R,
    IDMABSIZER, IDMACTRLR, MASKR, POWER, RESP1R, RESP2R, RESP3R, RESP4R, RESPCMDR, STAR,
};
