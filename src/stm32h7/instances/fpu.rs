...
pub use crate::stm32h7::peripherals::fpu::Instance;
pub use crate::stm32h7::peripherals::fpu::{RegisterBlock, ResetValues};
pub use crate::stm32h7::peripherals::fpu::{FPCAR, FPCCR, FPSCR};
