...
pub use crate::stm32h7::peripherals::rng::Instance;
pub use crate::stm32h7::peripherals::rng::{RegisterBlock, ResetValues};
pub use crate::stm32h7::peripherals::rng::{CR, DR, SR};
...
pub const RNG: *const RegisterBlock = 0x48021800 as *const _;
