...
pub use crate::stm32h7::peripherals::lpuart1::Instance;
pub use crate::stm32h7::peripherals::lpuart1::{RegisterBlock, ResetValues};
pub use crate::stm32h7::peripherals::lpuart1::{
...
pub const LPUART1: *const RegisterBlock = 0x58000c00 as *const _;
