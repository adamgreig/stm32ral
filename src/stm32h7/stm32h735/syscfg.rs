...
pub mod CFGR {
    ...
    /// Programmable voltage detector lockup bit
    pub mod PVDL {
        /// Offset (2 bits)
        pub const offset: u32 = 2;
        /// Mask (1 bit: 1 << 2)
    ...
    /// Backup RAM Double error lockup bit
    pub mod BKRAML {
        /// Offset (7 bits)
        pub const offset: u32 = 7;
        /// Mask (1 bit: 1 << 7)
    ...
    /// DTCM-RAM Double error lockup bit
    pub mod DTCML {
        /// Offset (13 bits)
    ...
    /// ITCM-RAM Double error lockup bit
    pub mod ITCML {
        /// Offset (14 bits)
    ...
    /// AXISRAM Double error lockup bit
    pub mod AXIRAML {
        /// Offset (15 bits)
...
pub mod ADC2ALT {
    ...
    /// ADC2 V_INP17 alternate connection
    pub mod ADC2_ROUT1 {
        /// Offset (1 bits)
        pub const offset: u32 = 1;
        /// Mask (1 bit: 1 << 1)
    ...
    /// ADC2 V_INP16 alternate connection
    pub mod ADC2_ROUT0 {
        /// Offset (0 bits)
        pub const offset: u32 = 0;
        /// Mask (1 bit: 1 << 0)
...
pub mod UR18 {
    ...
    /// CPU maximum frequency boost
    pub mod CPU_FREQ_BOOST {
        /// Offset (0 bits)
        pub const offset: u32 = 0;
        /// Mask (1 bit: 1 << 0)
        pub const mask: u32 = 1 << offset;
...
pub struct RegisterBlock {
    ...
    /// SYSCFG user register 12
    pub UR12: RORegister<u32>,

    /// SYSCFG user register 13
    pub UR13: RORegister<u32>,
    ...
    /// SYSCFG user register 17
    pub UR17: RORegister<u32>,

    /// SYSCFG user register 18
    pub UR18: RORegister<u32>,
}
