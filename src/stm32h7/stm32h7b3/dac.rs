...
pub use crate::stm32h7::peripherals::dac::Instance;
pub use crate::stm32h7::peripherals::dac::{RegisterBlock, ResetValues};
pub use crate::stm32h7::peripherals::dac::{
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const DAC2: *const RegisterBlock = 0x58003400 as *const _;
