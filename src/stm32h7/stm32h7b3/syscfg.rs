...
pub mod SYSCFG_BRK_LOCKUPR {
    ...
    /// Flash double ECC error lock bit
    pub mod FLASHL {
        /// Offset (3 bits)
        pub const offset: u32 = 3;
        /// Mask (1 bit: 1 << 3)
    ...
    /// CortexÃ‚Â®-M7 LOCKUP (HardFault) output enable bit
    pub mod CM7L {
        /// Offset (6 bits)
        pub const offset: u32 = 6;
        /// Mask (1 bit: 1 << 6)
    ...
    /// D1TCM or D0TCM double ECC error signal lock
    pub mod DTCML {
        /// Offset (13 bits)
    ...
    /// ITCM double ECC error signal lock
    pub mod ITCML {
        /// Offset (14 bits)
