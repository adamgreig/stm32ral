...
pub mod EECR3 {
    pub use super::EECR2::EE10POL;
    pub use super::EECR2::EE10SNS;
    pub use super::EECR2::EE10SRC;
    pub use super::EECR2::EE6POL;
    pub use super::EECR2::EE6SNS;
    pub use super::EECR2::EE6SRC;
    pub use super::EECR2::EE7POL;
    pub use super::EECR2::EE7SNS;
    pub use super::EECR2::EE7SRC;
    pub use super::EECR2::EE8POL;
    pub use super::EECR2::EE8SNS;
    pub use super::EECR2::EE8SRC;
    pub use super::EECR2::EE9POL;
    pub use super::EECR2::EE9SNS;
    pub use super::EECR2::EE9SRC;
}
