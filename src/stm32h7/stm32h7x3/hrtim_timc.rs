...
pub mod SETC2R {
    pub use super::SETC1R::CMP1;
    pub use super::SETC1R::CMP2;
    pub use super::SETC1R::CMP3;
    pub use super::SETC1R::CMP4;
    pub use super::SETC1R::EXTEVNT1;
    pub use super::SETC1R::EXTEVNT10;
    pub use super::SETC1R::EXTEVNT2;
    pub use super::SETC1R::EXTEVNT3;
    pub use super::SETC1R::EXTEVNT4;
    pub use super::SETC1R::EXTEVNT5;
    pub use super::SETC1R::EXTEVNT6;
    pub use super::SETC1R::EXTEVNT7;
    pub use super::SETC1R::EXTEVNT8;
    pub use super::SETC1R::EXTEVNT9;
    pub use super::SETC1R::MSTCMP1;
    pub use super::SETC1R::MSTCMP2;
    pub use super::SETC1R::MSTCMP3;
    pub use super::SETC1R::MSTCMP4;
    pub use super::SETC1R::MSTPER;
    pub use super::SETC1R::PER;
    pub use super::SETC1R::RESYNC;
    pub use super::SETC1R::SST;
    pub use super::SETC1R::TIMEVNT1;
    pub use super::SETC1R::TIMEVNT2;
    pub use super::SETC1R::TIMEVNT3;
    pub use super::SETC1R::TIMEVNT4;
    pub use super::SETC1R::TIMEVNT5;
    pub use super::SETC1R::TIMEVNT6;
    pub use super::SETC1R::TIMEVNT7;
    pub use super::SETC1R::TIMEVNT8;
    pub use super::SETC1R::TIMEVNT9;
    pub use super::SETC1R::UPDATE;
}

/// Timerx Output2 Reset Register
pub mod RSTC2R {
    pub use super::RSTC1R::CMP1;
    pub use super::RSTC1R::CMP2;
    pub use super::RSTC1R::CMP3;
    pub use super::RSTC1R::CMP4;
    pub use super::RSTC1R::EXTEVNT1;
    pub use super::RSTC1R::EXTEVNT10;
    pub use super::RSTC1R::EXTEVNT2;
    pub use super::RSTC1R::EXTEVNT3;
    pub use super::RSTC1R::EXTEVNT4;
    pub use super::RSTC1R::EXTEVNT5;
    pub use super::RSTC1R::EXTEVNT6;
    pub use super::RSTC1R::EXTEVNT7;
    pub use super::RSTC1R::EXTEVNT8;
    pub use super::RSTC1R::EXTEVNT9;
    pub use super::RSTC1R::MSTCMP1;
    pub use super::RSTC1R::MSTCMP2;
    pub use super::RSTC1R::MSTCMP3;
    pub use super::RSTC1R::MSTCMP4;
    pub use super::RSTC1R::MSTPER;
    pub use super::RSTC1R::PER;
    pub use super::RSTC1R::RESYNC;
    pub use super::RSTC1R::SRT;
    pub use super::RSTC1R::TIMEVNT1;
    pub use super::RSTC1R::TIMEVNT2;
    pub use super::RSTC1R::TIMEVNT3;
    pub use super::RSTC1R::TIMEVNT4;
    pub use super::RSTC1R::TIMEVNT5;
    pub use super::RSTC1R::TIMEVNT6;
    pub use super::RSTC1R::TIMEVNT7;
    pub use super::RSTC1R::TIMEVNT8;
    pub use super::RSTC1R::TIMEVNT9;
    pub use super::RSTC1R::UPDATE;
}
...
/// CPT2xCR
pub mod CPT2CCR {
    pub use super::CPT1CCR::EXEV10CPT;
    pub use super::CPT1CCR::EXEV1CPT;
    pub use super::CPT1CCR::EXEV2CPT;
    pub use super::CPT1CCR::EXEV3CPT;
    pub use super::CPT1CCR::EXEV4CPT;
    pub use super::CPT1CCR::EXEV5CPT;
    pub use super::CPT1CCR::EXEV6CPT;
    pub use super::CPT1CCR::EXEV7CPT;
    pub use super::CPT1CCR::EXEV8CPT;
    pub use super::CPT1CCR::EXEV9CPT;
    pub use super::CPT1CCR::SWCPT;
    pub use super::CPT1CCR::TA1RST;
    pub use super::CPT1CCR::TA1SET;
    pub use super::CPT1CCR::TACMP1;
    pub use super::CPT1CCR::TACMP2;
    pub use super::CPT1CCR::TB1RST;
    pub use super::CPT1CCR::TB1SET;
    pub use super::CPT1CCR::TBCMP1;
    pub use super::CPT1CCR::TBCMP2;
    pub use super::CPT1CCR::TD1RST;
    pub use super::CPT1CCR::TD1SET;
    pub use super::CPT1CCR::TDCMP1;
    pub use super::CPT1CCR::TDCMP2;
    pub use super::CPT1CCR::TE1RST;
    pub use super::CPT1CCR::TE1SET;
    pub use super::CPT1CCR::TECMP1;
    pub use super::CPT1CCR::TECMP2;
    pub use super::CPT1CCR::UDPCPT;
}
...
pub struct RegisterBlock {
    /// Timerx Control Register
    pub TIMCCR: RWRegister<u32>,

    /// Timerx Interrupt Status Register
    pub TIMCISR: RORegister<u32>,

    /// Timerx Interrupt Clear Register
    pub TIMCICR: WORegister<u32>,

    /// TIMxDIER5
    pub TIMCDIER5: RWRegister<u32>,

    /// Timerx Counter Register
    pub CNTCR: RWRegister<u32>,

    /// Timerx Period Register
    pub PERCR: RWRegister<u32>,

    /// Timerx Repetition Register
    pub REPCR: RWRegister<u32>,

    /// Timerx Compare 1 Register
    pub CMP1CR: RWRegister<u32>,

    /// Timerx Compare 1 Compound Register
    pub CMP1CCR: RWRegister<u32>,

    /// Timerx Compare 2 Register
    pub CMP2CR: RWRegister<u32>,

    /// Timerx Compare 3 Register
    pub CMP3CR: RWRegister<u32>,

    /// Timerx Compare 4 Register
    pub CMP4CR: RWRegister<u32>,

    /// Timerx Capture 1 Register
    pub CPT1CR: RORegister<u32>,

    /// Timerx Capture 2 Register
    pub CPT2CR: RORegister<u32>,

    /// Timerx Deadtime Register
    pub DTCR: RWRegister<u32>,

    /// Timerx Output1 Set Register
    pub SETC1R: RWRegister<u32>,

    /// Timerx Output1 Reset Register
    pub RSTC1R: RWRegister<u32>,

    /// Timerx Output2 Set Register
    pub SETC2R: RWRegister<u32>,

    /// Timerx Output2 Reset Register
    pub RSTC2R: RWRegister<u32>,

    /// Timerx External Event Filtering Register 1
    pub EEFCR1: RWRegister<u32>,

    /// Timerx External Event Filtering Register 2
    pub EEFCR2: RWRegister<u32>,

    /// TimerA Reset Register
    pub RSTCR: RWRegister<u32>,

    /// Timerx Chopper Register
    pub CHPCR: RWRegister<u32>,

    /// Timerx Capture 2 Control Register
    pub CPT1CCR: RWRegister<u32>,

    /// CPT2xCR
    pub CPT2CCR: RWRegister<u32>,

    /// Timerx Output Register
    pub OUTCR: RWRegister<u32>,
